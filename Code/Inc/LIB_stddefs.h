/******************************************************************************
  ...
  (c) 2004 - 2022 Xantrex Canada ULC. All rights reserved.
  All trademarks are owned or licensed by Xantrex Canada ULC,
  its subsidiaries or affiliated companies.

****************************************************************************//**

  @addtogroup libstddefs LIBSTDDEFS
  @{
  @brief Provides Xantrex C standard library definitions
...
****************************************************************************//**
  ...
  @note
    Depending on the architecture of the device, one of the following
    MUST be defined in this file for the project to compile properly:
         _8BIT_ARCHITECTURE
        _16BIT_ARCHITECTURE
        _32BIT_ARCHITECTURE
...
/*==============================================================================
                              Includes
==============================================================================*/
#include "LIB_stdtype.h"    // Xantrex standard type definitions
...
//! Standard macro for marking method parameters as unused
#ifndef UNUSED
