...
XANTREX CHANGE HISTORY:
$History: DSP281x_GlobalVariableDefs.c $
    
    *****************  Version 2  *****************
    User: Karli        Date: 9/30/04    Time: 10:54a
    Updated in $/PD/Inverter_Charger/Nova_Series/Code/Baseline/C28x/Src
    Uncomment CPU Timer variable declaration for use with uCOS-II
...
// -> Uncommented for use with uC/OS-II - 22 Sep 04
