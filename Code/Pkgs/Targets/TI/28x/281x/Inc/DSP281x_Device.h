...
$History: DSP281x_Device.h $
    
    *****************  Version 2  *****************
    User: Karli        Date: 9/30/04    Time: 10:47a
    Updated in $/PD/Inverter_Charger/Nova_Series/Code/Baseline/C28x/Inc
    Commented out TI typedef for float32  (it collides with our own)
...
// commented out -- this collides with equivalent Xantrex type - 23 Sep 04
