...
$History: DSP281x_Headers_nonBIOS.cmd $
 * 
 * *****************  Version 2  *****************
 * User: Karli        Date: 10/11/04   Time: 4:46p
 * Updated in $/PD/Inverter_Charger/Nova_Series/Code/Baseline/C28x/Linker
 * Supply SECTIONS for non-Bios CPU Timers used by uCos-II
