...
FILE NAME:  spidrvsim.c

PURPOSE:
    simulation of SPI driver for EE test.
...
$Log: spidrvsim.c $
    ...
    ***********************************************
    ...
    User: TrevorM     Date: 03/02/05  Time: 10:32PM
    Added spiclient.h to includes
