...
NOTES:
    ...
    In the board revisions, CC = Compatibility Code. See Xantrex documentaiton
    process for details.
...
// Texas Instruments TMS320LF2812A EVM configuration
#define CTRL_CONFIG_CPU     ( CTRL_CPU_TI_TMS320LF2812A )// 75 MIPs
#define CTRL_CONFIG_CRYSTAL ( 30000000L                 )// Hz
#define CTRL_CONFIG_EEDRV   ( CTRL_EEDRV_INVL           )
#define CTRL_CPU_MAXSPEED   ( 75000000L                 )// 75 MIPs
...
#error No control configuration selected. 
#endif 
