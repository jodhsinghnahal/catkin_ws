...
$Log: init.c $
    ...
    ***********************************************
    ...
    - This version has the external memory setup stuff
...
#define mCALC_PLL_DIV( MAX_SPD, XTAL_SPD )  ( (uint32)( MAX_SPD / XTAL_SPD ) * \
                                              (uint32)( 2                  ) )
// The actual PLL divider value to write to the register
#define PLLCR_PLL_DIV  mCALC_PLL_DIV( CTRL_CPU_MAXSPEED, CTRL_CONFIG_CRYSTAL )
...
#if ( INIT_EXTMEM_EN == TRUE )
#pragma CODE_SECTION(init_fnInitExtMemory, ".init")
#pragma CODE_SECTION(init_fnInitXTIMING6, ".init")
...
Version: 1.00  Date: JAN-07-2005  By: Trevor Monk
    - Initial Release
...
void init_fnInitExtMemory(void)
{
    ...
    // Automatically grants a request to an external device that is driving 
...
void init_fnInitSystemControlRegs( void )
{
    ...
    SysCtrlRegs.PLLCR.bit.DIV = PLLCR_PLL_DIV;
