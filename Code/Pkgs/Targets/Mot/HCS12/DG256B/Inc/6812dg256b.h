...
/* Based on CPU DB MC9S12DG256_112, version 2.87.214 (RegistersPrg V1.007) */
#ifndef _MC9S12DG256_112_H
#define _MC9S12DG256_112_H
...
#define PORTA_BIT _PORTA.MergedBits.BIT
...
#define PORTB_BIT1 _PORTB.Bits.BIT1
#define PORTB_BIT2 _PORTB.Bits.BIT2
#define PORTB_BIT3 _PORTB.Bits.BIT3
...
#define PORTB_BIT _PORTB.MergedBits.BIT
...
#define DDRA_BIT _DDRA.MergedBits.BIT
...
#define DDRB_BIT0 _DDRB.Bits.BIT0
#define DDRB_BIT1 _DDRB.Bits.BIT1
#define DDRB_BIT2 _DDRB.Bits.BIT2
#define DDRB_BIT3 _DDRB.Bits.BIT3
...
#define DDRB_BIT _DDRB.MergedBits.BIT
...
#define PORTE_BIT _PORTE.MergedBits.BIT
...
#define DDRE_BIT _DDRE.MergedBits.BIT
...
#define INITRM_RAM1_1 _INITRM.MergedBits.RAM1_1
...
#define INITRG_REG1_1 _INITRG.MergedBits.REG1_1
...
#define INITEE_EE1_2 _INITEE.MergedBits.EE1_2
...
#define MISC_EXSTR _MISC.MergedBits.EXSTR
...
#define MTST0_BIT _MTST0.MergedBits.BIT
...
#define ITCR_ADR _ITCR.MergedBits.ADR
...
#define MTST1_BIT _MTST1.MergedBits.BIT
...
#define PARTIDL_ID _PARTIDL.MergedBits.ID

/*** MEMSIZ0 - Memory Size Register Zero ***/
typedef union {
  byte Byte;
  struct {
...
#define MEMSIZ0_ram_sw _MEMSIZ0.MergedBits.ram_sw
#define MEMSIZ0_eep_sw _MEMSIZ0.MergedBits.eep_sw

/*** MEMSIZ1 - Memory Size Register One ***/
typedef union {
  byte Byte;
  struct {
...
#define MEMSIZ1_pag_sw _MEMSIZ1.MergedBits.pag_sw
#define MEMSIZ1_rom_sw _MEMSIZ1.MergedBits.rom_sw
...
#define HPRIO_PSEL_1 _HPRIO.MergedBits.PSEL_1
...
/*** BKP0X - First Address Memory Expansion Breakpoint Register ***/
typedef union {
  byte Byte;
  struct {
...
#define BKP0X_BK0V _BKP0X.MergedBits.BK0V

/*** BKP0H - First Address High Byte Breakpoint Register ***/
typedef union {
  byte Byte;
  struct {
...
#define BKP0H_BIT_8 _BKP0H.MergedBits.BIT_8

/*** BKP0L - First Address Low Byte Breakpoint Register ***/
typedef union {
  byte Byte;
  struct {
...
#define BKP0L_BIT _BKP0L.MergedBits.BIT

/*** BKP1X - Second Address Memory Expansion Breakpoint Register ***/
typedef union {
  byte Byte;
  struct {
...
#define BKP1X_BK1V _BKP1X.MergedBits.BK1V

/*** BKP1H - Data (Second Address) High Byte Breakpoint Register ***/
typedef union {
  byte Byte;
  struct {
...
#define BKP1H_BIT_8 _BKP1H.MergedBits.BIT_8

/*** BKP1L - Data (Second Address) Low Byte Breakpoint Register ***/
typedef union {
  byte Byte;
  struct {
...
#define BKP1L_BIT _BKP1L.MergedBits.BIT

/*** PPAGE - Page Index Register ***/
typedef union {
  byte Byte;
  struct {
...
#define PPAGE_PIX _PPAGE.MergedBits.PIX
...
#define PORTK_BIT _PORTK.MergedBits.BIT
...
#define DDRK_DDK _DDRK.MergedBits.DDK
...
#define SYNR_SYN _SYNR.MergedBits.SYN
...
#define REFDV_REFDV _REFDV.MergedBits.REFDV

/*** CTFLG - CRG Test Flags Register ***/
typedef union {
  byte Byte;
  struct {
...
#define CTFLG_TOUT _CTFLG.MergedBits.TOUT
...
#define RTICTL_RTR _RTICTL.MergedBits.RTR
...
#define COPCTL_CR _COPCTL.MergedBits.CR

/*** CTCTL - CRG Test Control Register ***/
typedef union {
  byte Byte;
  struct {
...
#define CTCTL_TCTL _CTCTL.MergedBits.TCTL
...
#define ARMCOP_BIT _ARMCOP.MergedBits.BIT
...
#define TIOS_IOS _TIOS.MergedBits.IOS
...
#define CFORC_FOC _CFORC.MergedBits.FOC
...
#define OC7M_OC7M _OC7M.MergedBits.OC7M
...
#define OC7D_OC7D _OC7D.MergedBits.OC7D

/*** TCNTHi - Timer Count Register High ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile TCNTHiSTR _TCNTHi @(REG_BASE + 0x00000044);
#define TCNTHi _TCNTHi.Byte
#define TCNTHi_BIT15 _TCNTHi.Bits.BIT15
#define TCNTHi_BIT14 _TCNTHi.Bits.BIT14
#define TCNTHi_BIT13 _TCNTHi.Bits.BIT13
#define TCNTHi_BIT12 _TCNTHi.Bits.BIT12
#define TCNTHi_BIT11 _TCNTHi.Bits.BIT11
#define TCNTHi_BIT10 _TCNTHi.Bits.BIT10
#define TCNTHi_BIT9 _TCNTHi.Bits.BIT9
#define TCNTHi_BIT8 _TCNTHi.Bits.BIT8

/*** TCNTLo - Timer Count Register Low ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile TCNTLoSTR _TCNTLo @(REG_BASE + 0x00000045);
#define TCNTLo _TCNTLo.Byte
#define TCNTLo_BIT0 _TCNTLo.Bits.BIT0
#define TCNTLo_BIT1 _TCNTLo.Bits.BIT1
#define TCNTLo_BIT2 _TCNTLo.Bits.BIT2
#define TCNTLo_BIT3 _TCNTLo.Bits.BIT3
#define TCNTLo_BIT4 _TCNTLo.Bits.BIT4
#define TCNTLo_BIT5 _TCNTLo.Bits.BIT5
#define TCNTLo_BIT6 _TCNTLo.Bits.BIT6
#define TCNTLo_BIT7 _TCNTLo.Bits.BIT7
#define TCNTLo_BIT _TCNTLo.MergedBits.BIT

/*** TSCR1 - Timer System Control Register1 ***/
typedef union {
  byte Byte;
  struct {
    byte         :1; 
...
#define TTOV_TOV _TTOV.MergedBits.TOV

/*** TCTL1 - Timer Control Registers 1 ***/
typedef union {
  byte Byte;
  struct {
...
/*** TCTL2 - Timer Control Registers 1 ***/
typedef union {
  byte Byte;
  struct {
...
#define TSCR2_PR _TSCR2.MergedBits.PR
...
/*** TC0Hi - Timer Input Capture/Output Compare Register 0 High ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile TC0HiSTR _TC0Hi @(REG_BASE + 0x00000050);
#define TC0Hi _TC0Hi.Byte
#define TC0Hi_BIT8 _TC0Hi.Bits.BIT8
#define TC0Hi_BIT9 _TC0Hi.Bits.BIT9
#define TC0Hi_BIT10 _TC0Hi.Bits.BIT10
#define TC0Hi_BIT11 _TC0Hi.Bits.BIT11
#define TC0Hi_BIT12 _TC0Hi.Bits.BIT12
#define TC0Hi_BIT13 _TC0Hi.Bits.BIT13
#define TC0Hi_BIT14 _TC0Hi.Bits.BIT14
#define TC0Hi_BIT15 _TC0Hi.Bits.BIT15
#define TC0Hi_BIT_8 _TC0Hi.MergedBits.BIT_8

/*** TC0Lo - Timer Input Capture/Output Compare Register 0 Low ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile TC0LoSTR _TC0Lo @(REG_BASE + 0x00000051);
#define TC0Lo _TC0Lo.Byte
#define TC0Lo_BIT0 _TC0Lo.Bits.BIT0
#define TC0Lo_BIT1 _TC0Lo.Bits.BIT1
#define TC0Lo_BIT2 _TC0Lo.Bits.BIT2
#define TC0Lo_BIT3 _TC0Lo.Bits.BIT3
#define TC0Lo_BIT4 _TC0Lo.Bits.BIT4
#define TC0Lo_BIT5 _TC0Lo.Bits.BIT5
#define TC0Lo_BIT6 _TC0Lo.Bits.BIT6
#define TC0Lo_BIT7 _TC0Lo.Bits.BIT7
#define TC0Lo_BIT _TC0Lo.MergedBits.BIT

/*** TC1Hi - Timer Input Capture/Output Compare Register 1 High ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile TC1HiSTR _TC1Hi @(REG_BASE + 0x00000052);
#define TC1Hi _TC1Hi.Byte
#define TC1Hi_BIT8 _TC1Hi.Bits.BIT8
#define TC1Hi_BIT9 _TC1Hi.Bits.BIT9
#define TC1Hi_BIT10 _TC1Hi.Bits.BIT10
#define TC1Hi_BIT11 _TC1Hi.Bits.BIT11
#define TC1Hi_BIT12 _TC1Hi.Bits.BIT12
#define TC1Hi_BIT13 _TC1Hi.Bits.BIT13
#define TC1Hi_BIT14 _TC1Hi.Bits.BIT14
#define TC1Hi_BIT15 _TC1Hi.Bits.BIT15
#define TC1Hi_BIT_8 _TC1Hi.MergedBits.BIT_8

/*** TC1Lo - Timer Input Capture/Output Compare Register 1 Low ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile TC1LoSTR _TC1Lo @(REG_BASE + 0x00000053);
#define TC1Lo _TC1Lo.Byte
#define TC1Lo_BIT0 _TC1Lo.Bits.BIT0
#define TC1Lo_BIT1 _TC1Lo.Bits.BIT1
#define TC1Lo_BIT2 _TC1Lo.Bits.BIT2
#define TC1Lo_BIT3 _TC1Lo.Bits.BIT3
#define TC1Lo_BIT4 _TC1Lo.Bits.BIT4
#define TC1Lo_BIT5 _TC1Lo.Bits.BIT5
#define TC1Lo_BIT6 _TC1Lo.Bits.BIT6
#define TC1Lo_BIT7 _TC1Lo.Bits.BIT7
#define TC1Lo_BIT _TC1Lo.MergedBits.BIT

/*** TC2Hi - Timer Input Capture/Output Compare Register 2 High ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile TC2HiSTR _TC2Hi @(REG_BASE + 0x00000054);
#define TC2Hi _TC2Hi.Byte
#define TC2Hi_BIT8 _TC2Hi.Bits.BIT8
#define TC2Hi_BIT9 _TC2Hi.Bits.BIT9
#define TC2Hi_BIT10 _TC2Hi.Bits.BIT10
#define TC2Hi_BIT11 _TC2Hi.Bits.BIT11
#define TC2Hi_BIT12 _TC2Hi.Bits.BIT12
#define TC2Hi_BIT13 _TC2Hi.Bits.BIT13
#define TC2Hi_BIT14 _TC2Hi.Bits.BIT14
#define TC2Hi_BIT15 _TC2Hi.Bits.BIT15
#define TC2Hi_BIT_8 _TC2Hi.MergedBits.BIT_8

/*** TC2Lo - Timer Input Capture/Output Compare Register 2 Low ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile TC2LoSTR _TC2Lo @(REG_BASE + 0x00000055);
#define TC2Lo _TC2Lo.Byte
#define TC2Lo_BIT0 _TC2Lo.Bits.BIT0
#define TC2Lo_BIT1 _TC2Lo.Bits.BIT1
#define TC2Lo_BIT2 _TC2Lo.Bits.BIT2
#define TC2Lo_BIT3 _TC2Lo.Bits.BIT3
#define TC2Lo_BIT4 _TC2Lo.Bits.BIT4
#define TC2Lo_BIT5 _TC2Lo.Bits.BIT5
#define TC2Lo_BIT6 _TC2Lo.Bits.BIT6
#define TC2Lo_BIT7 _TC2Lo.Bits.BIT7
#define TC2Lo_BIT _TC2Lo.MergedBits.BIT

/*** TC3Hi - Timer Input Capture/Output Compare Register 3 High ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile TC3HiSTR _TC3Hi @(REG_BASE + 0x00000056);
#define TC3Hi _TC3Hi.Byte
#define TC3Hi_BIT8 _TC3Hi.Bits.BIT8
#define TC3Hi_BIT9 _TC3Hi.Bits.BIT9
#define TC3Hi_BIT10 _TC3Hi.Bits.BIT10
#define TC3Hi_BIT11 _TC3Hi.Bits.BIT11
#define TC3Hi_BIT12 _TC3Hi.Bits.BIT12
#define TC3Hi_BIT13 _TC3Hi.Bits.BIT13
#define TC3Hi_BIT14 _TC3Hi.Bits.BIT14
#define TC3Hi_BIT15 _TC3Hi.Bits.BIT15
#define TC3Hi_BIT_8 _TC3Hi.MergedBits.BIT_8

/*** TC3Lo - Timer Input Capture/Output Compare Register 3 Low ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile TC3LoSTR _TC3Lo @(REG_BASE + 0x00000057);
#define TC3Lo _TC3Lo.Byte
#define TC3Lo_BIT0 _TC3Lo.Bits.BIT0
#define TC3Lo_BIT1 _TC3Lo.Bits.BIT1
#define TC3Lo_BIT2 _TC3Lo.Bits.BIT2
#define TC3Lo_BIT3 _TC3Lo.Bits.BIT3
#define TC3Lo_BIT4 _TC3Lo.Bits.BIT4
#define TC3Lo_BIT5 _TC3Lo.Bits.BIT5
#define TC3Lo_BIT6 _TC3Lo.Bits.BIT6
#define TC3Lo_BIT7 _TC3Lo.Bits.BIT7
#define TC3Lo_BIT _TC3Lo.MergedBits.BIT

/*** TC4Hi - Timer Input Capture/Output Compare Register 4 High ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile TC4HiSTR _TC4Hi @(REG_BASE + 0x00000058);
#define TC4Hi _TC4Hi.Byte
#define TC4Hi_BIT8 _TC4Hi.Bits.BIT8
#define TC4Hi_BIT9 _TC4Hi.Bits.BIT9
#define TC4Hi_BIT10 _TC4Hi.Bits.BIT10
#define TC4Hi_BIT11 _TC4Hi.Bits.BIT11
#define TC4Hi_BIT12 _TC4Hi.Bits.BIT12
#define TC4Hi_BIT13 _TC4Hi.Bits.BIT13
#define TC4Hi_BIT14 _TC4Hi.Bits.BIT14
#define TC4Hi_BIT15 _TC4Hi.Bits.BIT15
#define TC4Hi_BIT_8 _TC4Hi.MergedBits.BIT_8

/*** TC4Lo - Timer Input Capture/Output Compare Register 4 Low ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile TC4LoSTR _TC4Lo @(REG_BASE + 0x00000059);
#define TC4Lo _TC4Lo.Byte
#define TC4Lo_BIT0 _TC4Lo.Bits.BIT0
#define TC4Lo_BIT1 _TC4Lo.Bits.BIT1
#define TC4Lo_BIT2 _TC4Lo.Bits.BIT2
#define TC4Lo_BIT3 _TC4Lo.Bits.BIT3
#define TC4Lo_BIT4 _TC4Lo.Bits.BIT4
#define TC4Lo_BIT5 _TC4Lo.Bits.BIT5
#define TC4Lo_BIT6 _TC4Lo.Bits.BIT6
#define TC4Lo_BIT7 _TC4Lo.Bits.BIT7
#define TC4Lo_BIT _TC4Lo.MergedBits.BIT

/*** TC5Hi - Timer Input Capture/Output Compare Register 5 High ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile TC5HiSTR _TC5Hi @(REG_BASE + 0x0000005A);
#define TC5Hi _TC5Hi.Byte
#define TC5Hi_BIT8 _TC5Hi.Bits.BIT8
#define TC5Hi_BIT9 _TC5Hi.Bits.BIT9
#define TC5Hi_BIT10 _TC5Hi.Bits.BIT10
#define TC5Hi_BIT11 _TC5Hi.Bits.BIT11
#define TC5Hi_BIT12 _TC5Hi.Bits.BIT12
#define TC5Hi_BIT13 _TC5Hi.Bits.BIT13
#define TC5Hi_BIT14 _TC5Hi.Bits.BIT14
#define TC5Hi_BIT15 _TC5Hi.Bits.BIT15
#define TC5Hi_BIT_8 _TC5Hi.MergedBits.BIT_8

/*** TC5Lo - Timer Input Capture/Output Compare Register 5 Low ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile TC5LoSTR _TC5Lo @(REG_BASE + 0x0000005B);
#define TC5Lo _TC5Lo.Byte
#define TC5Lo_BIT0 _TC5Lo.Bits.BIT0
#define TC5Lo_BIT1 _TC5Lo.Bits.BIT1
#define TC5Lo_BIT2 _TC5Lo.Bits.BIT2
#define TC5Lo_BIT3 _TC5Lo.Bits.BIT3
#define TC5Lo_BIT4 _TC5Lo.Bits.BIT4
#define TC5Lo_BIT5 _TC5Lo.Bits.BIT5
#define TC5Lo_BIT6 _TC5Lo.Bits.BIT6
#define TC5Lo_BIT7 _TC5Lo.Bits.BIT7
#define TC5Lo_BIT _TC5Lo.MergedBits.BIT

/*** TC6Hi - Timer Input Capture/Output Compare Register 6 High ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile TC6HiSTR _TC6Hi @(REG_BASE + 0x0000005C);
#define TC6Hi _TC6Hi.Byte
#define TC6Hi_BIT8 _TC6Hi.Bits.BIT8
#define TC6Hi_BIT9 _TC6Hi.Bits.BIT9
#define TC6Hi_BIT10 _TC6Hi.Bits.BIT10
#define TC6Hi_BIT11 _TC6Hi.Bits.BIT11
#define TC6Hi_BIT12 _TC6Hi.Bits.BIT12
#define TC6Hi_BIT13 _TC6Hi.Bits.BIT13
#define TC6Hi_BIT14 _TC6Hi.Bits.BIT14
#define TC6Hi_BIT15 _TC6Hi.Bits.BIT15
#define TC6Hi_BIT_8 _TC6Hi.MergedBits.BIT_8

/*** TC6Lo - Timer Input Capture/Output Compare Register 6 Low ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile TC6LoSTR _TC6Lo @(REG_BASE + 0x0000005D);
#define TC6Lo _TC6Lo.Byte
#define TC6Lo_BIT0 _TC6Lo.Bits.BIT0
#define TC6Lo_BIT1 _TC6Lo.Bits.BIT1
#define TC6Lo_BIT2 _TC6Lo.Bits.BIT2
#define TC6Lo_BIT3 _TC6Lo.Bits.BIT3
#define TC6Lo_BIT4 _TC6Lo.Bits.BIT4
#define TC6Lo_BIT5 _TC6Lo.Bits.BIT5
#define TC6Lo_BIT6 _TC6Lo.Bits.BIT6
#define TC6Lo_BIT7 _TC6Lo.Bits.BIT7
#define TC6Lo_BIT _TC6Lo.MergedBits.BIT

/*** TC7Hi - Timer Input Capture/Output Compare Register 7 High ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile TC7HiSTR _TC7Hi @(REG_BASE + 0x0000005E);
#define TC7Hi _TC7Hi.Byte
#define TC7Hi_BIT8 _TC7Hi.Bits.BIT8
#define TC7Hi_BIT9 _TC7Hi.Bits.BIT9
#define TC7Hi_BIT10 _TC7Hi.Bits.BIT10
#define TC7Hi_BIT11 _TC7Hi.Bits.BIT11
#define TC7Hi_BIT12 _TC7Hi.Bits.BIT12
#define TC7Hi_BIT13 _TC7Hi.Bits.BIT13
#define TC7Hi_BIT14 _TC7Hi.Bits.BIT14
#define TC7Hi_BIT15 _TC7Hi.Bits.BIT15
#define TC7Hi_BIT_8 _TC7Hi.MergedBits.BIT_8

/*** TC7Lo - Timer Input Capture/Output Compare Register 7 Low ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile TC7LoSTR _TC7Lo @(REG_BASE + 0x0000005F);
#define TC7Lo _TC7Lo.Byte
#define TC7Lo_BIT0 _TC7Lo.Bits.BIT0
#define TC7Lo_BIT1 _TC7Lo.Bits.BIT1
#define TC7Lo_BIT2 _TC7Lo.Bits.BIT2
#define TC7Lo_BIT3 _TC7Lo.Bits.BIT3
#define TC7Lo_BIT4 _TC7Lo.Bits.BIT4
#define TC7Lo_BIT5 _TC7Lo.Bits.BIT5
#define TC7Lo_BIT6 _TC7Lo.Bits.BIT6
#define TC7Lo_BIT7 _TC7Lo.Bits.BIT7
#define TC7Lo_BIT _TC7Lo.MergedBits.BIT
...
#define PACTL_CLK _PACTL.MergedBits.CLK
...
/*** PACN3 - Pulse Accumulators Count Register 3 ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile PACN3STR _PACN3 @(REG_BASE + 0x00000062);
#define PACN3 _PACN3.Byte
#define PACN3_BIT0 _PACN3.Bits.BIT0
#define PACN3_BIT1 _PACN3.Bits.BIT1
#define PACN3_BIT2 _PACN3.Bits.BIT2
#define PACN3_BIT3 _PACN3.Bits.BIT3
#define PACN3_BIT4 _PACN3.Bits.BIT4
#define PACN3_BIT5 _PACN3.Bits.BIT5
#define PACN3_BIT6 _PACN3.Bits.BIT6
#define PACN3_BIT7 _PACN3.Bits.BIT7
#define PACN3_BIT _PACN3.MergedBits.BIT

/*** PACN2 - Pulse Accumulators Count Register 2 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Pulse Accumulator bit 0 */
...
extern volatile PACN2STR _PACN2 @(REG_BASE + 0x00000063);
#define PACN2 _PACN2.Byte
#define PACN2_BIT0 _PACN2.Bits.BIT0
#define PACN2_BIT1 _PACN2.Bits.BIT1
#define PACN2_BIT2 _PACN2.Bits.BIT2
#define PACN2_BIT3 _PACN2.Bits.BIT3
#define PACN2_BIT4 _PACN2.Bits.BIT4
#define PACN2_BIT5 _PACN2.Bits.BIT5
#define PACN2_BIT6 _PACN2.Bits.BIT6
#define PACN2_BIT7 _PACN2.Bits.BIT7
#define PACN2_BIT _PACN2.MergedBits.BIT

/*** PACN1 - Pulse Accumulators Count Register 1 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Pulse Accumulator bit 0 */
...
extern volatile PACN1STR _PACN1 @(REG_BASE + 0x00000064);
#define PACN1 _PACN1.Byte
#define PACN1_BIT0 _PACN1.Bits.BIT0
#define PACN1_BIT1 _PACN1.Bits.BIT1
#define PACN1_BIT2 _PACN1.Bits.BIT2
#define PACN1_BIT3 _PACN1.Bits.BIT3
#define PACN1_BIT4 _PACN1.Bits.BIT4
#define PACN1_BIT5 _PACN1.Bits.BIT5
#define PACN1_BIT6 _PACN1.Bits.BIT6
#define PACN1_BIT7 _PACN1.Bits.BIT7
#define PACN1_BIT _PACN1.MergedBits.BIT

/*** PACN0 - Pulse Accumulators Count Register 0 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Pulse Accumulator bit 0 */
...
extern volatile PACN0STR _PACN0 @(REG_BASE + 0x00000065);
#define PACN0 _PACN0.Byte
#define PACN0_BIT0 _PACN0.Bits.BIT0
#define PACN0_BIT1 _PACN0.Bits.BIT1
#define PACN0_BIT2 _PACN0.Bits.BIT2
#define PACN0_BIT3 _PACN0.Bits.BIT3
#define PACN0_BIT4 _PACN0.Bits.BIT4
#define PACN0_BIT5 _PACN0.Bits.BIT5
#define PACN0_BIT6 _PACN0.Bits.BIT6
#define PACN0_BIT7 _PACN0.Bits.BIT7
#define PACN0_BIT _PACN0.MergedBits.BIT

/*** MCCTL - Modulus Down Counter underflow ***/
typedef union {
  byte Byte;
  struct {
...
#define MCCTL_MCPR _MCCTL.MergedBits.MCPR
...
#define MCFLG_POLF _MCFLG.MergedBits.POLF
...
#define DLYCT_DLY _DLYCT.MergedBits.DLY
...
#define ICOVW_NOVW _ICOVW.MergedBits.NOVW
...
/*** PA3H - 8-Bit Pulse Accumulators Holding Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Pulse Accumulator Bit 0 */
...
extern volatile PA3HSTR _PA3H @(REG_BASE + 0x00000072);
#define PA3H _PA3H.Byte
#define PA3H_BIT0 _PA3H.Bits.BIT0
#define PA3H_BIT1 _PA3H.Bits.BIT1
#define PA3H_BIT2 _PA3H.Bits.BIT2
#define PA3H_BIT3 _PA3H.Bits.BIT3
#define PA3H_BIT4 _PA3H.Bits.BIT4
#define PA3H_BIT5 _PA3H.Bits.BIT5
#define PA3H_BIT6 _PA3H.Bits.BIT6
#define PA3H_BIT7 _PA3H.Bits.BIT7
#define PA3H_BIT _PA3H.MergedBits.BIT

/*** PA2H - 8-Bit Pulse Accumulators Holding Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Pulse Accumulator Bit 0 */
...
extern volatile PA2HSTR _PA2H @(REG_BASE + 0x00000073);
#define PA2H _PA2H.Byte
#define PA2H_BIT0 _PA2H.Bits.BIT0
#define PA2H_BIT1 _PA2H.Bits.BIT1
#define PA2H_BIT2 _PA2H.Bits.BIT2
#define PA2H_BIT3 _PA2H.Bits.BIT3
#define PA2H_BIT4 _PA2H.Bits.BIT4
#define PA2H_BIT5 _PA2H.Bits.BIT5
#define PA2H_BIT6 _PA2H.Bits.BIT6
#define PA2H_BIT7 _PA2H.Bits.BIT7
#define PA2H_BIT _PA2H.MergedBits.BIT

/*** PA1H - 8-Bit Pulse Accumulators Holding Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Pulse Accumulator Bit 0 */
...
extern volatile PA1HSTR _PA1H @(REG_BASE + 0x00000074);
#define PA1H _PA1H.Byte
#define PA1H_BIT0 _PA1H.Bits.BIT0
#define PA1H_BIT1 _PA1H.Bits.BIT1
#define PA1H_BIT2 _PA1H.Bits.BIT2
#define PA1H_BIT3 _PA1H.Bits.BIT3
#define PA1H_BIT4 _PA1H.Bits.BIT4
#define PA1H_BIT5 _PA1H.Bits.BIT5
#define PA1H_BIT6 _PA1H.Bits.BIT6
#define PA1H_BIT7 _PA1H.Bits.BIT7
#define PA1H_BIT _PA1H.MergedBits.BIT

/*** PA0H - 8-Bit Pulse Accumulators Holding Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Pulse Accumulator Bit 0 */
...
extern volatile PA0HSTR _PA0H @(REG_BASE + 0x00000075);
#define PA0H _PA0H.Byte
#define PA0H_BIT0 _PA0H.Bits.BIT0
#define PA0H_BIT1 _PA0H.Bits.BIT1
#define PA0H_BIT2 _PA0H.Bits.BIT2
#define PA0H_BIT3 _PA0H.Bits.BIT3
#define PA0H_BIT4 _PA0H.Bits.BIT4
#define PA0H_BIT5 _PA0H.Bits.BIT5
#define PA0H_BIT6 _PA0H.Bits.BIT6
#define PA0H_BIT7 _PA0H.Bits.BIT7
#define PA0H_BIT _PA0H.MergedBits.BIT

/*** MCCNThi - Modulus Down-Counter Count Register High ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile MCCNThiSTR _MCCNThi @(REG_BASE + 0x00000076);
#define MCCNThi _MCCNThi.Byte
#define MCCNThi_BIT8 _MCCNThi.Bits.BIT8
#define MCCNThi_BIT9 _MCCNThi.Bits.BIT9
#define MCCNThi_BIT10 _MCCNThi.Bits.BIT10
#define MCCNThi_BIT11 _MCCNThi.Bits.BIT11
#define MCCNThi_BIT12 _MCCNThi.Bits.BIT12
#define MCCNThi_BIT13 _MCCNThi.Bits.BIT13
#define MCCNThi_BIT14 _MCCNThi.Bits.BIT14
#define MCCNThi_BIT15 _MCCNThi.Bits.BIT15
#define MCCNThi_BIT_8 _MCCNThi.MergedBits.BIT_8

/*** MCCNTlo - Modulus Down-Counter Count Register Low ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile MCCNTloSTR _MCCNTlo @(REG_BASE + 0x00000077);
#define MCCNTlo _MCCNTlo.Byte
#define MCCNTlo_BIT0 _MCCNTlo.Bits.BIT0
#define MCCNTlo_BIT1 _MCCNTlo.Bits.BIT1
#define MCCNTlo_BIT2 _MCCNTlo.Bits.BIT2
#define MCCNTlo_BIT3 _MCCNTlo.Bits.BIT3
#define MCCNTlo_BIT4 _MCCNTlo.Bits.BIT4
#define MCCNTlo_BIT5 _MCCNTlo.Bits.BIT5
#define MCCNTlo_BIT6 _MCCNTlo.Bits.BIT6
#define MCCNTlo_BIT7 _MCCNTlo.Bits.BIT7
#define MCCNTlo_BIT _MCCNTlo.MergedBits.BIT

/*** TC0Hhi - Timer Input Capture Holding Registers 0 High ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile TC0HhiSTR _TC0Hhi @(REG_BASE + 0x00000078);
#define TC0Hhi _TC0Hhi.Byte
#define TC0Hhi_BIT8 _TC0Hhi.Bits.BIT8
#define TC0Hhi_BIT9 _TC0Hhi.Bits.BIT9
#define TC0Hhi_BIT10 _TC0Hhi.Bits.BIT10
#define TC0Hhi_BIT11 _TC0Hhi.Bits.BIT11
#define TC0Hhi_BIT12 _TC0Hhi.Bits.BIT12
#define TC0Hhi_BIT13 _TC0Hhi.Bits.BIT13
#define TC0Hhi_BIT14 _TC0Hhi.Bits.BIT14
#define TC0Hhi_BIT15 _TC0Hhi.Bits.BIT15
#define TC0Hhi_BIT_8 _TC0Hhi.MergedBits.BIT_8

/*** TC0Hlo - Timer Input Capture Holding Registers 0 Low ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile TC0HloSTR _TC0Hlo @(REG_BASE + 0x00000079);
#define TC0Hlo _TC0Hlo.Byte
#define TC0Hlo_BIT0 _TC0Hlo.Bits.BIT0
#define TC0Hlo_BIT1 _TC0Hlo.Bits.BIT1
#define TC0Hlo_BIT2 _TC0Hlo.Bits.BIT2
#define TC0Hlo_BIT3 _TC0Hlo.Bits.BIT3
#define TC0Hlo_BIT4 _TC0Hlo.Bits.BIT4
#define TC0Hlo_BIT5 _TC0Hlo.Bits.BIT5
#define TC0Hlo_BIT6 _TC0Hlo.Bits.BIT6
#define TC0Hlo_BIT7 _TC0Hlo.Bits.BIT7
#define TC0Hlo_BIT _TC0Hlo.MergedBits.BIT

/*** TC1Hhi - Timer Input Capture Holding Registers 1 High ***/
typedef union {
  byte Byte;
  struct {
    byte BIT8    :1;           /* Timer Input Capture Holding Bit 8 */
...
extern volatile TC1HhiSTR _TC1Hhi @(REG_BASE + 0x0000007A);
#define TC1Hhi _TC1Hhi.Byte
#define TC1Hhi_BIT8 _TC1Hhi.Bits.BIT8
#define TC1Hhi_BIT9 _TC1Hhi.Bits.BIT9
#define TC1Hhi_BIT10 _TC1Hhi.Bits.BIT10
#define TC1Hhi_BIT11 _TC1Hhi.Bits.BIT11
#define TC1Hhi_BIT12 _TC1Hhi.Bits.BIT12
#define TC1Hhi_BIT13 _TC1Hhi.Bits.BIT13
#define TC1Hhi_BIT14 _TC1Hhi.Bits.BIT14
#define TC1Hhi_BIT15 _TC1Hhi.Bits.BIT15
#define TC1Hhi_BIT_8 _TC1Hhi.MergedBits.BIT_8
...
extern volatile TC1HloSTR _TC1Hlo @(REG_BASE + 0x0000007B);
#define TC1Hlo _TC1Hlo.Byte
#define TC1Hlo_BIT0 _TC1Hlo.Bits.BIT0
#define TC1Hlo_BIT1 _TC1Hlo.Bits.BIT1
#define TC1Hlo_BIT2 _TC1Hlo.Bits.BIT2
#define TC1Hlo_BIT3 _TC1Hlo.Bits.BIT3
#define TC1Hlo_BIT4 _TC1Hlo.Bits.BIT4
#define TC1Hlo_BIT5 _TC1Hlo.Bits.BIT5
#define TC1Hlo_BIT6 _TC1Hlo.Bits.BIT6
#define TC1Hlo_BIT7 _TC1Hlo.Bits.BIT7
#define TC1Hlo_BIT _TC1Hlo.MergedBits.BIT

/*** TC2Hhi - Timer Input Capture Holding Registers 2 High ***/
typedef union {
  byte Byte;
  struct {
    byte BIT8    :1;           /* Timer Input Capture Holding Bit 8 */
...
extern volatile TC2HhiSTR _TC2Hhi @(REG_BASE + 0x0000007C);
#define TC2Hhi _TC2Hhi.Byte
#define TC2Hhi_BIT8 _TC2Hhi.Bits.BIT8
#define TC2Hhi_BIT9 _TC2Hhi.Bits.BIT9
#define TC2Hhi_BIT10 _TC2Hhi.Bits.BIT10
#define TC2Hhi_BIT11 _TC2Hhi.Bits.BIT11
#define TC2Hhi_BIT12 _TC2Hhi.Bits.BIT12
#define TC2Hhi_BIT13 _TC2Hhi.Bits.BIT13
#define TC2Hhi_BIT14 _TC2Hhi.Bits.BIT14
#define TC2Hhi_BIT15 _TC2Hhi.Bits.BIT15
#define TC2Hhi_BIT_8 _TC2Hhi.MergedBits.BIT_8

/*** TC2Hlo - Timer Input Capture Holding Registers 2 Low ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Timer Input Capture Holding Bit 0 */
...
extern volatile TC2HloSTR _TC2Hlo @(REG_BASE + 0x0000007D);
#define TC2Hlo _TC2Hlo.Byte
#define TC2Hlo_BIT0 _TC2Hlo.Bits.BIT0
#define TC2Hlo_BIT1 _TC2Hlo.Bits.BIT1
#define TC2Hlo_BIT2 _TC2Hlo.Bits.BIT2
#define TC2Hlo_BIT3 _TC2Hlo.Bits.BIT3
#define TC2Hlo_BIT4 _TC2Hlo.Bits.BIT4
#define TC2Hlo_BIT5 _TC2Hlo.Bits.BIT5
#define TC2Hlo_BIT6 _TC2Hlo.Bits.BIT6
#define TC2Hlo_BIT7 _TC2Hlo.Bits.BIT7
#define TC2Hlo_BIT _TC2Hlo.MergedBits.BIT

/*** TC3Hhi - Timer Input Capture Holding Registers 3 High ***/
typedef union {
  byte Byte;
  struct {
    byte BIT8    :1;           /* Timer Input Capture Holding Bit 8 */
...
extern volatile TC3HhiSTR _TC3Hhi @(REG_BASE + 0x0000007E);
#define TC3Hhi _TC3Hhi.Byte
#define TC3Hhi_BIT8 _TC3Hhi.Bits.BIT8
#define TC3Hhi_BIT9 _TC3Hhi.Bits.BIT9
#define TC3Hhi_BIT10 _TC3Hhi.Bits.BIT10
#define TC3Hhi_BIT11 _TC3Hhi.Bits.BIT11
#define TC3Hhi_BIT12 _TC3Hhi.Bits.BIT12
#define TC3Hhi_BIT13 _TC3Hhi.Bits.BIT13
#define TC3Hhi_BIT14 _TC3Hhi.Bits.BIT14
#define TC3Hhi_BIT15 _TC3Hhi.Bits.BIT15
#define TC3Hhi_BIT_8 _TC3Hhi.MergedBits.BIT_8

/*** TC3Hlo - Timer Input Capture Holding Registers 3 Low ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Timer Input Capture Holding Bit 0 */
...
extern volatile TC3HloSTR _TC3Hlo @(REG_BASE + 0x0000007F);
#define TC3Hlo _TC3Hlo.Byte
#define TC3Hlo_BIT0 _TC3Hlo.Bits.BIT0
#define TC3Hlo_BIT1 _TC3Hlo.Bits.BIT1
#define TC3Hlo_BIT2 _TC3Hlo.Bits.BIT2
#define TC3Hlo_BIT3 _TC3Hlo.Bits.BIT3
#define TC3Hlo_BIT4 _TC3Hlo.Bits.BIT4
#define TC3Hlo_BIT5 _TC3Hlo.Bits.BIT5
#define TC3Hlo_BIT6 _TC3Hlo.Bits.BIT6
#define TC3Hlo_BIT7 _TC3Hlo.Bits.BIT7
#define TC3Hlo_BIT _TC3Hlo.MergedBits.BIT

/*** ATD0CTL2 - ATD Control Register 2 ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile ATD0CTL2STR _ATD0CTL2 @(REG_BASE + 0x00000082);
#define ATD0CTL2 _ATD0CTL2.Byte
#define ATD0CTL2_ASCIF _ATD0CTL2.Bits.ASCIF
#define ATD0CTL2_ASCIE _ATD0CTL2.Bits.ASCIE
#define ATD0CTL2_ETRIGE _ATD0CTL2.Bits.ETRIGE
#define ATD0CTL2_ETRIGP _ATD0CTL2.Bits.ETRIGP
#define ATD0CTL2_ETRIGLE _ATD0CTL2.Bits.ETRIGLE
#define ATD0CTL2_AWAI _ATD0CTL2.Bits.AWAI
#define ATD0CTL2_AFFC _ATD0CTL2.Bits.AFFC
#define ATD0CTL2_ADPU _ATD0CTL2.Bits.ADPU

/*** ATD0CTL3 - ATD Control Register 3 ***/
typedef union {
  byte Byte;
  struct {
    ...
    byte S1C     :1;           /* Conversion Sequence Length */
    byte S2C     :1;           /* Conversion Sequence Length */
    byte S4C     :1;           /* Conversion Sequence Length */
    byte S8C     :1;           /* Conversion Sequence Length */
    byte         :1; 
  } Bits;
  struct {
    byte FRZ     :2;
...
extern volatile ATD0CTL3STR _ATD0CTL3 @(REG_BASE + 0x00000083);
#define ATD0CTL3 _ATD0CTL3.Byte
#define ATD0CTL3_FRZ0 _ATD0CTL3.Bits.FRZ0
#define ATD0CTL3_FRZ1 _ATD0CTL3.Bits.FRZ1
#define ATD0CTL3_FIFO _ATD0CTL3.Bits.FIFO
#define ATD0CTL3_S1C _ATD0CTL3.Bits.S1C
#define ATD0CTL3_S2C _ATD0CTL3.Bits.S2C
#define ATD0CTL3_S4C _ATD0CTL3.Bits.S4C
#define ATD0CTL3_S8C _ATD0CTL3.Bits.S8C
#define ATD0CTL3_FRZ _ATD0CTL3.MergedBits.FRZ

/*** ATD0CTL4 - ATD Control Register 4 ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile ATD0CTL4STR _ATD0CTL4 @(REG_BASE + 0x00000084);
#define ATD0CTL4 _ATD0CTL4.Byte
#define ATD0CTL4_PRS0 _ATD0CTL4.Bits.PRS0
#define ATD0CTL4_PRS1 _ATD0CTL4.Bits.PRS1
#define ATD0CTL4_PRS2 _ATD0CTL4.Bits.PRS2
#define ATD0CTL4_PRS3 _ATD0CTL4.Bits.PRS3
#define ATD0CTL4_PRS4 _ATD0CTL4.Bits.PRS4
#define ATD0CTL4_SMP0 _ATD0CTL4.Bits.SMP0
#define ATD0CTL4_SMP1 _ATD0CTL4.Bits.SMP1
#define ATD0CTL4_SRES8 _ATD0CTL4.Bits.SRES8
#define ATD0CTL4_PRS _ATD0CTL4.MergedBits.PRS
#define ATD0CTL4_SMP _ATD0CTL4.MergedBits.SMP

/*** ATD0CTL5 - ATD Control Register 5 ***/
typedef union {
  byte Byte;
  struct {
    byte CA      :1;           /* Analog Input Channel Select Code */
    byte CB      :1;           /* Analog Input Channel Select Code */
    byte CC      :1;           /* Analog Input Channel Select Code */
    byte         :1; 
...
extern volatile ATD0CTL5STR _ATD0CTL5 @(REG_BASE + 0x00000085);
#define ATD0CTL5 _ATD0CTL5.Byte
#define ATD0CTL5_CA _ATD0CTL5.Bits.CA
#define ATD0CTL5_CB _ATD0CTL5.Bits.CB
#define ATD0CTL5_CC _ATD0CTL5.Bits.CC
#define ATD0CTL5_MULT _ATD0CTL5.Bits.MULT
#define ATD0CTL5_SCAN _ATD0CTL5.Bits.SCAN
#define ATD0CTL5_DSGN _ATD0CTL5.Bits.DSGN
#define ATD0CTL5_DJM _ATD0CTL5.Bits.DJM

/*** ATD0STAT0 - A/D Status Register 0 ***/
typedef union {
  byte Byte;
  struct {
...
#define ATD0STAT0_CC _ATD0STAT0.MergedBits.CC

/*** ATD0STAT1 - A/D Status Register 1 ***/
typedef union {
  byte Byte;
  struct {
...
#define ATD0STAT1_CCF _ATD0STAT1.MergedBits.CCF

/*** ATD0DIEN - ATD Input Enable Mask Register ***/
typedef union {
  byte Byte;
  struct {
...
#define ATD0DIEN_BIT _ATD0DIEN.MergedBits.BIT

/*** PORTAD0 - Port AD0 Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* AN0 */
...
#define PORTAD0_BIT _PORTAD0.MergedBits.BIT

/*** ATD0DR0H - A/D Conversion Result Register 0 High ***/
typedef union {
  byte Byte;
  struct {
    byte BIT8    :1;           /* Bit 8 */
...
extern volatile ATD0DR0HSTR _ATD0DR0H @(REG_BASE + 0x00000090);
#define ATD0DR0H _ATD0DR0H.Byte
#define ATD0DR0H_BIT8 _ATD0DR0H.Bits.BIT8
#define ATD0DR0H_BIT9 _ATD0DR0H.Bits.BIT9
#define ATD0DR0H_BIT10 _ATD0DR0H.Bits.BIT10
#define ATD0DR0H_BIT11 _ATD0DR0H.Bits.BIT11
#define ATD0DR0H_BIT12 _ATD0DR0H.Bits.BIT12
#define ATD0DR0H_BIT13 _ATD0DR0H.Bits.BIT13
#define ATD0DR0H_BIT14 _ATD0DR0H.Bits.BIT14
#define ATD0DR0H_BIT15 _ATD0DR0H.Bits.BIT15
#define ATD0DR0H_BIT_8 _ATD0DR0H.MergedBits.BIT_8

/*** ATD0DR0L - A/D Conversion Result Register 0 Low ***/
typedef union {
  byte Byte;
  struct {
    byte         :1; 
...
extern volatile ATD0DR0LSTR _ATD0DR0L @(REG_BASE + 0x00000091);
#define ATD0DR0L _ATD0DR0L.Byte
#define ATD0DR0L_BIT6 _ATD0DR0L.Bits.BIT6
#define ATD0DR0L_BIT7 _ATD0DR0L.Bits.BIT7
#define ATD0DR0L_BIT_6 _ATD0DR0L.MergedBits.BIT_6

/*** ATD0DR1H - A/D Conversion Result Register 1 High ***/
typedef union {
  byte Byte;
  struct {
    byte BIT8    :1;           /* Bit 8 */
...
extern volatile ATD0DR1HSTR _ATD0DR1H @(REG_BASE + 0x00000092);
#define ATD0DR1H _ATD0DR1H.Byte
#define ATD0DR1H_BIT8 _ATD0DR1H.Bits.BIT8
#define ATD0DR1H_BIT9 _ATD0DR1H.Bits.BIT9
#define ATD0DR1H_BIT10 _ATD0DR1H.Bits.BIT10
#define ATD0DR1H_BIT11 _ATD0DR1H.Bits.BIT11
#define ATD0DR1H_BIT12 _ATD0DR1H.Bits.BIT12
#define ATD0DR1H_BIT13 _ATD0DR1H.Bits.BIT13
#define ATD0DR1H_BIT14 _ATD0DR1H.Bits.BIT14
#define ATD0DR1H_BIT15 _ATD0DR1H.Bits.BIT15
#define ATD0DR1H_BIT_8 _ATD0DR1H.MergedBits.BIT_8

/*** ATD0DR1L - A/D Conversion Result Register 1 Low ***/
typedef union {
  byte Byte;
  struct {
    byte         :1; 
...
extern volatile ATD0DR1LSTR _ATD0DR1L @(REG_BASE + 0x00000093);
#define ATD0DR1L _ATD0DR1L.Byte
#define ATD0DR1L_BIT6 _ATD0DR1L.Bits.BIT6
#define ATD0DR1L_BIT7 _ATD0DR1L.Bits.BIT7
#define ATD0DR1L_BIT_6 _ATD0DR1L.MergedBits.BIT_6

/*** ATD0DR2H - A/D Conversion Result Register 2 High ***/
typedef union {
  byte Byte;
  struct {
    byte BIT8    :1;           /* Bit 8 */
...
extern volatile ATD0DR2HSTR _ATD0DR2H @(REG_BASE + 0x00000094);
#define ATD0DR2H _ATD0DR2H.Byte
#define ATD0DR2H_BIT8 _ATD0DR2H.Bits.BIT8
#define ATD0DR2H_BIT9 _ATD0DR2H.Bits.BIT9
#define ATD0DR2H_BIT10 _ATD0DR2H.Bits.BIT10
#define ATD0DR2H_BIT11 _ATD0DR2H.Bits.BIT11
#define ATD0DR2H_BIT12 _ATD0DR2H.Bits.BIT12
#define ATD0DR2H_BIT13 _ATD0DR2H.Bits.BIT13
#define ATD0DR2H_BIT14 _ATD0DR2H.Bits.BIT14
#define ATD0DR2H_BIT15 _ATD0DR2H.Bits.BIT15
#define ATD0DR2H_BIT_8 _ATD0DR2H.MergedBits.BIT_8

/*** ATD0DR2L - A/D Conversion Result Register 2 Low ***/
typedef union {
  byte Byte;
  struct {
    byte         :1; 
...
extern volatile ATD0DR2LSTR _ATD0DR2L @(REG_BASE + 0x00000095);
#define ATD0DR2L _ATD0DR2L.Byte
#define ATD0DR2L_BIT6 _ATD0DR2L.Bits.BIT6
#define ATD0DR2L_BIT7 _ATD0DR2L.Bits.BIT7
#define ATD0DR2L_BIT_6 _ATD0DR2L.MergedBits.BIT_6

/*** ATD0DR3H - A/D Conversion Result Register 3 High ***/
typedef union {
  byte Byte;
  struct {
    byte BIT8    :1;           /* Bit 8 */
...
extern volatile ATD0DR3HSTR _ATD0DR3H @(REG_BASE + 0x00000096);
#define ATD0DR3H _ATD0DR3H.Byte
#define ATD0DR3H_BIT8 _ATD0DR3H.Bits.BIT8
#define ATD0DR3H_BIT9 _ATD0DR3H.Bits.BIT9
#define ATD0DR3H_BIT10 _ATD0DR3H.Bits.BIT10
#define ATD0DR3H_BIT11 _ATD0DR3H.Bits.BIT11
#define ATD0DR3H_BIT12 _ATD0DR3H.Bits.BIT12
#define ATD0DR3H_BIT13 _ATD0DR3H.Bits.BIT13
#define ATD0DR3H_BIT14 _ATD0DR3H.Bits.BIT14
#define ATD0DR3H_BIT15 _ATD0DR3H.Bits.BIT15
#define ATD0DR3H_BIT_8 _ATD0DR3H.MergedBits.BIT_8

/*** ATD0DR3L - A/D Conversion Result Register 3 Low ***/
typedef union {
  byte Byte;
  struct {
    byte         :1; 
...
extern volatile ATD0DR3LSTR _ATD0DR3L @(REG_BASE + 0x00000097);
#define ATD0DR3L _ATD0DR3L.Byte
#define ATD0DR3L_BIT6 _ATD0DR3L.Bits.BIT6
#define ATD0DR3L_BIT7 _ATD0DR3L.Bits.BIT7
#define ATD0DR3L_BIT_6 _ATD0DR3L.MergedBits.BIT_6

/*** ATD0DR4H - A/D Conversion Result Register 4 High ***/
typedef union {
  byte Byte;
  struct {
    byte BIT8    :1;           /* Bit 8 */
...
extern volatile ATD0DR4HSTR _ATD0DR4H @(REG_BASE + 0x00000098);
#define ATD0DR4H _ATD0DR4H.Byte
#define ATD0DR4H_BIT8 _ATD0DR4H.Bits.BIT8
#define ATD0DR4H_BIT9 _ATD0DR4H.Bits.BIT9
#define ATD0DR4H_BIT10 _ATD0DR4H.Bits.BIT10
#define ATD0DR4H_BIT11 _ATD0DR4H.Bits.BIT11
#define ATD0DR4H_BIT12 _ATD0DR4H.Bits.BIT12
#define ATD0DR4H_BIT13 _ATD0DR4H.Bits.BIT13
#define ATD0DR4H_BIT14 _ATD0DR4H.Bits.BIT14
#define ATD0DR4H_BIT15 _ATD0DR4H.Bits.BIT15
#define ATD0DR4H_BIT_8 _ATD0DR4H.MergedBits.BIT_8

/*** ATD0DR4L - A/D Conversion Result Register 4 Low ***/
typedef union {
  byte Byte;
  struct {
    byte         :1; 
...
extern volatile ATD0DR4LSTR _ATD0DR4L @(REG_BASE + 0x00000099);
#define ATD0DR4L _ATD0DR4L.Byte
#define ATD0DR4L_BIT6 _ATD0DR4L.Bits.BIT6
#define ATD0DR4L_BIT7 _ATD0DR4L.Bits.BIT7
#define ATD0DR4L_BIT_6 _ATD0DR4L.MergedBits.BIT_6

/*** ATD0DR5H - A/D Conversion Result Register 5 High ***/
typedef union {
  byte Byte;
  struct {
    byte BIT8    :1;           /* Bit 8 */
...
extern volatile ATD0DR5HSTR _ATD0DR5H @(REG_BASE + 0x0000009A);
#define ATD0DR5H _ATD0DR5H.Byte
#define ATD0DR5H_BIT8 _ATD0DR5H.Bits.BIT8
#define ATD0DR5H_BIT9 _ATD0DR5H.Bits.BIT9
#define ATD0DR5H_BIT10 _ATD0DR5H.Bits.BIT10
#define ATD0DR5H_BIT11 _ATD0DR5H.Bits.BIT11
#define ATD0DR5H_BIT12 _ATD0DR5H.Bits.BIT12
#define ATD0DR5H_BIT13 _ATD0DR5H.Bits.BIT13
#define ATD0DR5H_BIT14 _ATD0DR5H.Bits.BIT14
#define ATD0DR5H_BIT15 _ATD0DR5H.Bits.BIT15
#define ATD0DR5H_BIT_8 _ATD0DR5H.MergedBits.BIT_8

/*** ATD0DR5L - A/D Conversion Result Register 5 Low ***/
typedef union {
  byte Byte;
  struct {
    byte         :1; 
...
extern volatile ATD0DR5LSTR _ATD0DR5L @(REG_BASE + 0x0000009B);
#define ATD0DR5L _ATD0DR5L.Byte
#define ATD0DR5L_BIT6 _ATD0DR5L.Bits.BIT6
#define ATD0DR5L_BIT7 _ATD0DR5L.Bits.BIT7
#define ATD0DR5L_BIT_6 _ATD0DR5L.MergedBits.BIT_6

/*** ATD0DR6H - A/D Conversion Result Register 6 High ***/
typedef union {
  byte Byte;
  struct {
    byte BIT8    :1;           /* Bit 8 */
...
extern volatile ATD0DR6HSTR _ATD0DR6H @(REG_BASE + 0x0000009C);
#define ATD0DR6H _ATD0DR6H.Byte
#define ATD0DR6H_BIT8 _ATD0DR6H.Bits.BIT8
#define ATD0DR6H_BIT9 _ATD0DR6H.Bits.BIT9
#define ATD0DR6H_BIT10 _ATD0DR6H.Bits.BIT10
#define ATD0DR6H_BIT11 _ATD0DR6H.Bits.BIT11
#define ATD0DR6H_BIT12 _ATD0DR6H.Bits.BIT12
#define ATD0DR6H_BIT13 _ATD0DR6H.Bits.BIT13
#define ATD0DR6H_BIT14 _ATD0DR6H.Bits.BIT14
#define ATD0DR6H_BIT15 _ATD0DR6H.Bits.BIT15
#define ATD0DR6H_BIT_8 _ATD0DR6H.MergedBits.BIT_8

/*** ATD0DR6L - A/D Conversion Result Register 6 Low ***/
typedef union {
  byte Byte;
  struct {
    byte         :1; 
...
extern volatile ATD0DR6LSTR _ATD0DR6L @(REG_BASE + 0x0000009D);
#define ATD0DR6L _ATD0DR6L.Byte
#define ATD0DR6L_BIT6 _ATD0DR6L.Bits.BIT6
#define ATD0DR6L_BIT7 _ATD0DR6L.Bits.BIT7
#define ATD0DR6L_BIT_6 _ATD0DR6L.MergedBits.BIT_6

/*** ATD0DR7H - A/D Conversion Result Register 7 High ***/
typedef union {
  byte Byte;
  struct {
    byte BIT8    :1;           /* Bit 8 */
...
extern volatile ATD0DR7HSTR _ATD0DR7H @(REG_BASE + 0x0000009E);
#define ATD0DR7H _ATD0DR7H.Byte
#define ATD0DR7H_BIT8 _ATD0DR7H.Bits.BIT8
#define ATD0DR7H_BIT9 _ATD0DR7H.Bits.BIT9
#define ATD0DR7H_BIT10 _ATD0DR7H.Bits.BIT10
#define ATD0DR7H_BIT11 _ATD0DR7H.Bits.BIT11
#define ATD0DR7H_BIT12 _ATD0DR7H.Bits.BIT12
#define ATD0DR7H_BIT13 _ATD0DR7H.Bits.BIT13
#define ATD0DR7H_BIT14 _ATD0DR7H.Bits.BIT14
#define ATD0DR7H_BIT15 _ATD0DR7H.Bits.BIT15
#define ATD0DR7H_BIT_8 _ATD0DR7H.MergedBits.BIT_8

/*** ATD0DR7L - A/D Conversion Result Register 7 Low ***/
typedef union {
  byte Byte;
  struct {
    byte         :1; 
...
extern volatile ATD0DR7LSTR _ATD0DR7L @(REG_BASE + 0x0000009F);
#define ATD0DR7L _ATD0DR7L.Byte
#define ATD0DR7L_BIT6 _ATD0DR7L.Bits.BIT6
#define ATD0DR7L_BIT7 _ATD0DR7L.Bits.BIT7
#define ATD0DR7L_BIT_6 _ATD0DR7L.MergedBits.BIT_6
...
#define PWME_PWME _PWME.MergedBits.PWME
...
#define PWMPOL_PPOL _PWMPOL.MergedBits.PPOL
...
#define PWMCLK_PCLK _PWMCLK.MergedBits.PCLK
...
#define PWMPRCLK_PCKA _PWMPRCLK.MergedBits.PCKA
#define PWMPRCLK_PCKB _PWMPRCLK.MergedBits.PCKB
...
#define PWMCAE_CAE _PWMCAE.MergedBits.CAE
...
#define PWMSCLA_BIT _PWMSCLA.MergedBits.BIT
...
#define PWMSCLB_BIT _PWMSCLB.MergedBits.BIT

/*** PWMCNT0 - PWM Channel Counter Register ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile PWMCNT0STR _PWMCNT0 @(REG_BASE + 0x000000AC);
#define PWMCNT0 _PWMCNT0.Byte
#define PWMCNT0_BIT0 _PWMCNT0.Bits.BIT0
#define PWMCNT0_BIT1 _PWMCNT0.Bits.BIT1
#define PWMCNT0_BIT2 _PWMCNT0.Bits.BIT2
#define PWMCNT0_BIT3 _PWMCNT0.Bits.BIT3
#define PWMCNT0_BIT4 _PWMCNT0.Bits.BIT4
#define PWMCNT0_BIT5 _PWMCNT0.Bits.BIT5
#define PWMCNT0_BIT6 _PWMCNT0.Bits.BIT6
#define PWMCNT0_BIT7 _PWMCNT0.Bits.BIT7
#define PWMCNT0_BIT _PWMCNT0.MergedBits.BIT

/*** PWMCNT1 - PWM Channel Counter Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* PWM Channel Counter Bit 0 */
...
extern volatile PWMCNT1STR _PWMCNT1 @(REG_BASE + 0x000000AD);
#define PWMCNT1 _PWMCNT1.Byte
#define PWMCNT1_BIT0 _PWMCNT1.Bits.BIT0
#define PWMCNT1_BIT1 _PWMCNT1.Bits.BIT1
#define PWMCNT1_BIT2 _PWMCNT1.Bits.BIT2
#define PWMCNT1_BIT3 _PWMCNT1.Bits.BIT3
#define PWMCNT1_BIT4 _PWMCNT1.Bits.BIT4
#define PWMCNT1_BIT5 _PWMCNT1.Bits.BIT5
#define PWMCNT1_BIT6 _PWMCNT1.Bits.BIT6
#define PWMCNT1_BIT7 _PWMCNT1.Bits.BIT7
#define PWMCNT1_BIT _PWMCNT1.MergedBits.BIT

/*** PWMCNT2 - PWM Channel Counter Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* PWM Channel Counter Bit 0 */
...
extern volatile PWMCNT2STR _PWMCNT2 @(REG_BASE + 0x000000AE);
#define PWMCNT2 _PWMCNT2.Byte
#define PWMCNT2_BIT0 _PWMCNT2.Bits.BIT0
#define PWMCNT2_BIT1 _PWMCNT2.Bits.BIT1
#define PWMCNT2_BIT2 _PWMCNT2.Bits.BIT2
#define PWMCNT2_BIT3 _PWMCNT2.Bits.BIT3
#define PWMCNT2_BIT4 _PWMCNT2.Bits.BIT4
#define PWMCNT2_BIT5 _PWMCNT2.Bits.BIT5
#define PWMCNT2_BIT6 _PWMCNT2.Bits.BIT6
#define PWMCNT2_BIT7 _PWMCNT2.Bits.BIT7
#define PWMCNT2_BIT _PWMCNT2.MergedBits.BIT

/*** PWMCNT3 - PWM Channel Counter Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* PWM Channel Counter Bit 0 */
...
extern volatile PWMCNT3STR _PWMCNT3 @(REG_BASE + 0x000000AF);
#define PWMCNT3 _PWMCNT3.Byte
#define PWMCNT3_BIT0 _PWMCNT3.Bits.BIT0
#define PWMCNT3_BIT1 _PWMCNT3.Bits.BIT1
#define PWMCNT3_BIT2 _PWMCNT3.Bits.BIT2
#define PWMCNT3_BIT3 _PWMCNT3.Bits.BIT3
#define PWMCNT3_BIT4 _PWMCNT3.Bits.BIT4
#define PWMCNT3_BIT5 _PWMCNT3.Bits.BIT5
#define PWMCNT3_BIT6 _PWMCNT3.Bits.BIT6
#define PWMCNT3_BIT7 _PWMCNT3.Bits.BIT7
#define PWMCNT3_BIT _PWMCNT3.MergedBits.BIT

/*** PWMCNT4 - PWM Channel Counter Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* PWM Channel Counter Bit 0 */
...
extern volatile PWMCNT4STR _PWMCNT4 @(REG_BASE + 0x000000B0);
#define PWMCNT4 _PWMCNT4.Byte
#define PWMCNT4_BIT0 _PWMCNT4.Bits.BIT0
#define PWMCNT4_BIT1 _PWMCNT4.Bits.BIT1
#define PWMCNT4_BIT2 _PWMCNT4.Bits.BIT2
#define PWMCNT4_BIT3 _PWMCNT4.Bits.BIT3
#define PWMCNT4_BIT4 _PWMCNT4.Bits.BIT4
#define PWMCNT4_BIT5 _PWMCNT4.Bits.BIT5
#define PWMCNT4_BIT6 _PWMCNT4.Bits.BIT6
#define PWMCNT4_BIT7 _PWMCNT4.Bits.BIT7
#define PWMCNT4_BIT _PWMCNT4.MergedBits.BIT

/*** PWMCNT5 - PWM Channel Counter Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* PWM Channel Counter Bit 0 */
...
extern volatile PWMCNT5STR _PWMCNT5 @(REG_BASE + 0x000000B1);
#define PWMCNT5 _PWMCNT5.Byte
#define PWMCNT5_BIT0 _PWMCNT5.Bits.BIT0
#define PWMCNT5_BIT1 _PWMCNT5.Bits.BIT1
#define PWMCNT5_BIT2 _PWMCNT5.Bits.BIT2
#define PWMCNT5_BIT3 _PWMCNT5.Bits.BIT3
#define PWMCNT5_BIT4 _PWMCNT5.Bits.BIT4
#define PWMCNT5_BIT5 _PWMCNT5.Bits.BIT5
#define PWMCNT5_BIT6 _PWMCNT5.Bits.BIT6
#define PWMCNT5_BIT7 _PWMCNT5.Bits.BIT7
#define PWMCNT5_BIT _PWMCNT5.MergedBits.BIT

/*** PWMCNT6 - PWM Channel Counter Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* PWM Channel Counter Bit 0 */
...
extern volatile PWMCNT6STR _PWMCNT6 @(REG_BASE + 0x000000B2);
#define PWMCNT6 _PWMCNT6.Byte
#define PWMCNT6_BIT0 _PWMCNT6.Bits.BIT0
#define PWMCNT6_BIT1 _PWMCNT6.Bits.BIT1
#define PWMCNT6_BIT2 _PWMCNT6.Bits.BIT2
#define PWMCNT6_BIT3 _PWMCNT6.Bits.BIT3
#define PWMCNT6_BIT4 _PWMCNT6.Bits.BIT4
#define PWMCNT6_BIT5 _PWMCNT6.Bits.BIT5
#define PWMCNT6_BIT6 _PWMCNT6.Bits.BIT6
#define PWMCNT6_BIT7 _PWMCNT6.Bits.BIT7
#define PWMCNT6_BIT _PWMCNT6.MergedBits.BIT

/*** PWMCNT7 - PWM Channel Counter Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* PWM Channel Counter Bit 0 */
...
extern volatile PWMCNT7STR _PWMCNT7 @(REG_BASE + 0x000000B3);
#define PWMCNT7 _PWMCNT7.Byte
#define PWMCNT7_BIT0 _PWMCNT7.Bits.BIT0
#define PWMCNT7_BIT1 _PWMCNT7.Bits.BIT1
#define PWMCNT7_BIT2 _PWMCNT7.Bits.BIT2
#define PWMCNT7_BIT3 _PWMCNT7.Bits.BIT3
#define PWMCNT7_BIT4 _PWMCNT7.Bits.BIT4
#define PWMCNT7_BIT5 _PWMCNT7.Bits.BIT5
#define PWMCNT7_BIT6 _PWMCNT7.Bits.BIT6
#define PWMCNT7_BIT7 _PWMCNT7.Bits.BIT7
#define PWMCNT7_BIT _PWMCNT7.MergedBits.BIT

/*** PWMPER0 - PWM Channel Period Register ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile PWMPER0STR _PWMPER0 @(REG_BASE + 0x000000B4);
#define PWMPER0 _PWMPER0.Byte
#define PWMPER0_BIT0 _PWMPER0.Bits.BIT0
#define PWMPER0_BIT1 _PWMPER0.Bits.BIT1
#define PWMPER0_BIT2 _PWMPER0.Bits.BIT2
#define PWMPER0_BIT3 _PWMPER0.Bits.BIT3
#define PWMPER0_BIT4 _PWMPER0.Bits.BIT4
#define PWMPER0_BIT5 _PWMPER0.Bits.BIT5
#define PWMPER0_BIT6 _PWMPER0.Bits.BIT6
#define PWMPER0_BIT7 _PWMPER0.Bits.BIT7
#define PWMPER0_BIT _PWMPER0.MergedBits.BIT

/*** PWMPER1 - PWM Channel Period Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* PWM Channel Period Bit 0 */
...
extern volatile PWMPER1STR _PWMPER1 @(REG_BASE + 0x000000B5);
#define PWMPER1 _PWMPER1.Byte
#define PWMPER1_BIT0 _PWMPER1.Bits.BIT0
#define PWMPER1_BIT1 _PWMPER1.Bits.BIT1
#define PWMPER1_BIT2 _PWMPER1.Bits.BIT2
#define PWMPER1_BIT3 _PWMPER1.Bits.BIT3
#define PWMPER1_BIT4 _PWMPER1.Bits.BIT4
#define PWMPER1_BIT5 _PWMPER1.Bits.BIT5
#define PWMPER1_BIT6 _PWMPER1.Bits.BIT6
#define PWMPER1_BIT7 _PWMPER1.Bits.BIT7
#define PWMPER1_BIT _PWMPER1.MergedBits.BIT

/*** PWMPER2 - PWM Channel Period Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* PWM Channel Period Bit 0 */
...
extern volatile PWMPER2STR _PWMPER2 @(REG_BASE + 0x000000B6);
#define PWMPER2 _PWMPER2.Byte
#define PWMPER2_BIT0 _PWMPER2.Bits.BIT0
#define PWMPER2_BIT1 _PWMPER2.Bits.BIT1
#define PWMPER2_BIT2 _PWMPER2.Bits.BIT2
#define PWMPER2_BIT3 _PWMPER2.Bits.BIT3
#define PWMPER2_BIT4 _PWMPER2.Bits.BIT4
#define PWMPER2_BIT5 _PWMPER2.Bits.BIT5
#define PWMPER2_BIT6 _PWMPER2.Bits.BIT6
#define PWMPER2_BIT7 _PWMPER2.Bits.BIT7
#define PWMPER2_BIT _PWMPER2.MergedBits.BIT

/*** PWMPER3 - PWM Channel Period Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* PWM Channel Period Bit 0 */
...
extern volatile PWMPER3STR _PWMPER3 @(REG_BASE + 0x000000B7);
#define PWMPER3 _PWMPER3.Byte
#define PWMPER3_BIT0 _PWMPER3.Bits.BIT0
#define PWMPER3_BIT1 _PWMPER3.Bits.BIT1
#define PWMPER3_BIT2 _PWMPER3.Bits.BIT2
#define PWMPER3_BIT3 _PWMPER3.Bits.BIT3
#define PWMPER3_BIT4 _PWMPER3.Bits.BIT4
#define PWMPER3_BIT5 _PWMPER3.Bits.BIT5
#define PWMPER3_BIT6 _PWMPER3.Bits.BIT6
#define PWMPER3_BIT7 _PWMPER3.Bits.BIT7
#define PWMPER3_BIT _PWMPER3.MergedBits.BIT

/*** PWMPER4 - PWM Channel Period Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* PWM Channel Period Bit 0 */
...
extern volatile PWMPER4STR _PWMPER4 @(REG_BASE + 0x000000B8);
#define PWMPER4 _PWMPER4.Byte
#define PWMPER4_BIT0 _PWMPER4.Bits.BIT0
#define PWMPER4_BIT1 _PWMPER4.Bits.BIT1
#define PWMPER4_BIT2 _PWMPER4.Bits.BIT2
#define PWMPER4_BIT3 _PWMPER4.Bits.BIT3
#define PWMPER4_BIT4 _PWMPER4.Bits.BIT4
#define PWMPER4_BIT5 _PWMPER4.Bits.BIT5
#define PWMPER4_BIT6 _PWMPER4.Bits.BIT6
#define PWMPER4_BIT7 _PWMPER4.Bits.BIT7
#define PWMPER4_BIT _PWMPER4.MergedBits.BIT

/*** PWMPER5 - PWM Channel Period Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* PWM Channel Period Bit 0 */
...
extern volatile PWMPER5STR _PWMPER5 @(REG_BASE + 0x000000B9);
#define PWMPER5 _PWMPER5.Byte
#define PWMPER5_BIT0 _PWMPER5.Bits.BIT0
#define PWMPER5_BIT1 _PWMPER5.Bits.BIT1
#define PWMPER5_BIT2 _PWMPER5.Bits.BIT2
#define PWMPER5_BIT3 _PWMPER5.Bits.BIT3
#define PWMPER5_BIT4 _PWMPER5.Bits.BIT4
#define PWMPER5_BIT5 _PWMPER5.Bits.BIT5
#define PWMPER5_BIT6 _PWMPER5.Bits.BIT6
#define PWMPER5_BIT7 _PWMPER5.Bits.BIT7
#define PWMPER5_BIT _PWMPER5.MergedBits.BIT

/*** PWMPER6 - PWM Channel Period Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* PWM Channel Period Bit 0 */
...
extern volatile PWMPER6STR _PWMPER6 @(REG_BASE + 0x000000BA);
#define PWMPER6 _PWMPER6.Byte
#define PWMPER6_BIT0 _PWMPER6.Bits.BIT0
#define PWMPER6_BIT1 _PWMPER6.Bits.BIT1
#define PWMPER6_BIT2 _PWMPER6.Bits.BIT2
#define PWMPER6_BIT3 _PWMPER6.Bits.BIT3
#define PWMPER6_BIT4 _PWMPER6.Bits.BIT4
#define PWMPER6_BIT5 _PWMPER6.Bits.BIT5
#define PWMPER6_BIT6 _PWMPER6.Bits.BIT6
#define PWMPER6_BIT7 _PWMPER6.Bits.BIT7
#define PWMPER6_BIT _PWMPER6.MergedBits.BIT

/*** PWMPER7 - PWM Channel Period Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* PWM Channel Period Bit 0 */
...
extern volatile PWMPER7STR _PWMPER7 @(REG_BASE + 0x000000BB);
#define PWMPER7 _PWMPER7.Byte
#define PWMPER7_BIT0 _PWMPER7.Bits.BIT0
#define PWMPER7_BIT1 _PWMPER7.Bits.BIT1
#define PWMPER7_BIT2 _PWMPER7.Bits.BIT2
#define PWMPER7_BIT3 _PWMPER7.Bits.BIT3
#define PWMPER7_BIT4 _PWMPER7.Bits.BIT4
#define PWMPER7_BIT5 _PWMPER7.Bits.BIT5
#define PWMPER7_BIT6 _PWMPER7.Bits.BIT6
#define PWMPER7_BIT7 _PWMPER7.Bits.BIT7
#define PWMPER7_BIT _PWMPER7.MergedBits.BIT

/*** PWMDTY0 - PWM Channel Duty Register ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile PWMDTY0STR _PWMDTY0 @(REG_BASE + 0x000000BC);
#define PWMDTY0 _PWMDTY0.Byte
#define PWMDTY0_BIT0 _PWMDTY0.Bits.BIT0
#define PWMDTY0_BIT1 _PWMDTY0.Bits.BIT1
#define PWMDTY0_BIT2 _PWMDTY0.Bits.BIT2
#define PWMDTY0_BIT3 _PWMDTY0.Bits.BIT3
#define PWMDTY0_BIT4 _PWMDTY0.Bits.BIT4
#define PWMDTY0_BIT5 _PWMDTY0.Bits.BIT5
#define PWMDTY0_BIT6 _PWMDTY0.Bits.BIT6
#define PWMDTY0_BIT7 _PWMDTY0.Bits.BIT7
#define PWMDTY0_BIT _PWMDTY0.MergedBits.BIT

/*** PWMDTY1 - PWM Channel Duty Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* PWM Channel Duty Bit 0 */
...
extern volatile PWMDTY1STR _PWMDTY1 @(REG_BASE + 0x000000BD);
#define PWMDTY1 _PWMDTY1.Byte
#define PWMDTY1_BIT0 _PWMDTY1.Bits.BIT0
#define PWMDTY1_BIT1 _PWMDTY1.Bits.BIT1
#define PWMDTY1_BIT2 _PWMDTY1.Bits.BIT2
#define PWMDTY1_BIT3 _PWMDTY1.Bits.BIT3
#define PWMDTY1_BIT4 _PWMDTY1.Bits.BIT4
#define PWMDTY1_BIT5 _PWMDTY1.Bits.BIT5
#define PWMDTY1_BIT6 _PWMDTY1.Bits.BIT6
#define PWMDTY1_BIT7 _PWMDTY1.Bits.BIT7
#define PWMDTY1_BIT _PWMDTY1.MergedBits.BIT

/*** PWMDTY2 - PWM Channel Duty Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* PWM Channel Duty Bit 0 */
...
extern volatile PWMDTY2STR _PWMDTY2 @(REG_BASE + 0x000000BE);
#define PWMDTY2 _PWMDTY2.Byte
#define PWMDTY2_BIT0 _PWMDTY2.Bits.BIT0
#define PWMDTY2_BIT1 _PWMDTY2.Bits.BIT1
#define PWMDTY2_BIT2 _PWMDTY2.Bits.BIT2
#define PWMDTY2_BIT3 _PWMDTY2.Bits.BIT3
#define PWMDTY2_BIT4 _PWMDTY2.Bits.BIT4
#define PWMDTY2_BIT5 _PWMDTY2.Bits.BIT5
#define PWMDTY2_BIT6 _PWMDTY2.Bits.BIT6
#define PWMDTY2_BIT7 _PWMDTY2.Bits.BIT7
#define PWMDTY2_BIT _PWMDTY2.MergedBits.BIT

/*** PWMDTY3 - PWM Channel Duty Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* PWM Channel Duty Bit 0 */
...
extern volatile PWMDTY3STR _PWMDTY3 @(REG_BASE + 0x000000BF);
#define PWMDTY3 _PWMDTY3.Byte
#define PWMDTY3_BIT0 _PWMDTY3.Bits.BIT0
#define PWMDTY3_BIT1 _PWMDTY3.Bits.BIT1
#define PWMDTY3_BIT2 _PWMDTY3.Bits.BIT2
#define PWMDTY3_BIT3 _PWMDTY3.Bits.BIT3
#define PWMDTY3_BIT4 _PWMDTY3.Bits.BIT4
#define PWMDTY3_BIT5 _PWMDTY3.Bits.BIT5
#define PWMDTY3_BIT6 _PWMDTY3.Bits.BIT6
#define PWMDTY3_BIT7 _PWMDTY3.Bits.BIT7
#define PWMDTY3_BIT _PWMDTY3.MergedBits.BIT

/*** PWMDTY4 - PWM Channel Duty Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* PWM Channel Duty Bit 0 */
...
extern volatile PWMDTY4STR _PWMDTY4 @(REG_BASE + 0x000000C0);
#define PWMDTY4 _PWMDTY4.Byte
#define PWMDTY4_BIT0 _PWMDTY4.Bits.BIT0
#define PWMDTY4_BIT1 _PWMDTY4.Bits.BIT1
#define PWMDTY4_BIT2 _PWMDTY4.Bits.BIT2
#define PWMDTY4_BIT3 _PWMDTY4.Bits.BIT3
#define PWMDTY4_BIT4 _PWMDTY4.Bits.BIT4
#define PWMDTY4_BIT5 _PWMDTY4.Bits.BIT5
#define PWMDTY4_BIT6 _PWMDTY4.Bits.BIT6
#define PWMDTY4_BIT7 _PWMDTY4.Bits.BIT7
#define PWMDTY4_BIT _PWMDTY4.MergedBits.BIT

/*** PWMDTY5 - PWM Channel Duty Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* PWM Channel Duty Bit 0 */
...
extern volatile PWMDTY5STR _PWMDTY5 @(REG_BASE + 0x000000C1);
#define PWMDTY5 _PWMDTY5.Byte
#define PWMDTY5_BIT0 _PWMDTY5.Bits.BIT0
#define PWMDTY5_BIT1 _PWMDTY5.Bits.BIT1
#define PWMDTY5_BIT2 _PWMDTY5.Bits.BIT2
#define PWMDTY5_BIT3 _PWMDTY5.Bits.BIT3
#define PWMDTY5_BIT4 _PWMDTY5.Bits.BIT4
#define PWMDTY5_BIT5 _PWMDTY5.Bits.BIT5
#define PWMDTY5_BIT6 _PWMDTY5.Bits.BIT6
#define PWMDTY5_BIT7 _PWMDTY5.Bits.BIT7
#define PWMDTY5_BIT _PWMDTY5.MergedBits.BIT

/*** PWMDTY6 - PWM Channel Duty Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* PWM Channel Duty Bit 0 */
...
extern volatile PWMDTY6STR _PWMDTY6 @(REG_BASE + 0x000000C2);
#define PWMDTY6 _PWMDTY6.Byte
#define PWMDTY6_BIT0 _PWMDTY6.Bits.BIT0
#define PWMDTY6_BIT1 _PWMDTY6.Bits.BIT1
#define PWMDTY6_BIT2 _PWMDTY6.Bits.BIT2
#define PWMDTY6_BIT3 _PWMDTY6.Bits.BIT3
#define PWMDTY6_BIT4 _PWMDTY6.Bits.BIT4
#define PWMDTY6_BIT5 _PWMDTY6.Bits.BIT5
#define PWMDTY6_BIT6 _PWMDTY6.Bits.BIT6
#define PWMDTY6_BIT7 _PWMDTY6.Bits.BIT7
#define PWMDTY6_BIT _PWMDTY6.MergedBits.BIT

/*** PWMDTY7 - PWM Channel Duty Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* PWM Channel Duty Bit 0 */
...
extern volatile PWMDTY7STR _PWMDTY7 @(REG_BASE + 0x000000C3);
#define PWMDTY7 _PWMDTY7.Byte
#define PWMDTY7_BIT0 _PWMDTY7.Bits.BIT0
#define PWMDTY7_BIT1 _PWMDTY7.Bits.BIT1
#define PWMDTY7_BIT2 _PWMDTY7.Bits.BIT2
#define PWMDTY7_BIT3 _PWMDTY7.Bits.BIT3
#define PWMDTY7_BIT4 _PWMDTY7.Bits.BIT4
#define PWMDTY7_BIT5 _PWMDTY7.Bits.BIT5
#define PWMDTY7_BIT6 _PWMDTY7.Bits.BIT6
#define PWMDTY7_BIT7 _PWMDTY7.Bits.BIT7
#define PWMDTY7_BIT _PWMDTY7.MergedBits.BIT
...
/*** SCI0BDH - SCI Baud Rate Register High ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile SCI0BDHSTR _SCI0BDH @(REG_BASE + 0x000000C8);
#define SCI0BDH _SCI0BDH.Byte
#define SCI0BDH_SBR8 _SCI0BDH.Bits.SBR8
#define SCI0BDH_SBR9 _SCI0BDH.Bits.SBR9
#define SCI0BDH_SBR10 _SCI0BDH.Bits.SBR10
#define SCI0BDH_SBR11 _SCI0BDH.Bits.SBR11
#define SCI0BDH_SBR12 _SCI0BDH.Bits.SBR12
#define SCI0BDH_SBR_8 _SCI0BDH.MergedBits.SBR_8

/*** SCI0BDL - SCI Baud Rate Register Low ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile SCI0BDLSTR _SCI0BDL @(REG_BASE + 0x000000C9);
#define SCI0BDL _SCI0BDL.Byte
#define SCI0BDL_SBR0 _SCI0BDL.Bits.SBR0
#define SCI0BDL_SBR1 _SCI0BDL.Bits.SBR1
#define SCI0BDL_SBR2 _SCI0BDL.Bits.SBR2
#define SCI0BDL_SBR3 _SCI0BDL.Bits.SBR3
#define SCI0BDL_SBR4 _SCI0BDL.Bits.SBR4
#define SCI0BDL_SBR5 _SCI0BDL.Bits.SBR5
#define SCI0BDL_SBR6 _SCI0BDL.Bits.SBR6
#define SCI0BDL_SBR7 _SCI0BDL.Bits.SBR7
#define SCI0BDL_SBR _SCI0BDL.MergedBits.SBR

/*** SCI0CR1 - SCI Control Register 1 ***/
typedef union {
  byte Byte;
  struct {
...
/*** SCI0CR2 - SCI Control Register 2 ***/
typedef union {
  byte Byte;
  struct {
...
/*** SCI0DRH - SCI Data Register High ***/
typedef union {
  byte Byte;
  struct {
    byte         :1; 
...
/*** SCI1BDH - SCI Baud Rate Register High ***/
typedef union {
  byte Byte;
  struct {
    byte SBR8    :1;           /* SCI baud rate Bit 8 */
...
extern volatile SCI1BDHSTR _SCI1BDH @(REG_BASE + 0x000000D0);
#define SCI1BDH _SCI1BDH.Byte
#define SCI1BDH_SBR8 _SCI1BDH.Bits.SBR8
#define SCI1BDH_SBR9 _SCI1BDH.Bits.SBR9
#define SCI1BDH_SBR10 _SCI1BDH.Bits.SBR10
#define SCI1BDH_SBR11 _SCI1BDH.Bits.SBR11
#define SCI1BDH_SBR12 _SCI1BDH.Bits.SBR12
#define SCI1BDH_SBR_8 _SCI1BDH.MergedBits.SBR_8

/*** SCI1BDL - SCI Baud Rate Register Low ***/
typedef union {
  byte Byte;
  struct {
    byte SBR0    :1;           /* SCI baud rate Bit 0 */
...
extern volatile SCI1BDLSTR _SCI1BDL @(REG_BASE + 0x000000D1);
#define SCI1BDL _SCI1BDL.Byte
#define SCI1BDL_SBR0 _SCI1BDL.Bits.SBR0
#define SCI1BDL_SBR1 _SCI1BDL.Bits.SBR1
#define SCI1BDL_SBR2 _SCI1BDL.Bits.SBR2
#define SCI1BDL_SBR3 _SCI1BDL.Bits.SBR3
#define SCI1BDL_SBR4 _SCI1BDL.Bits.SBR4
#define SCI1BDL_SBR5 _SCI1BDL.Bits.SBR5
#define SCI1BDL_SBR6 _SCI1BDL.Bits.SBR6
#define SCI1BDL_SBR7 _SCI1BDL.Bits.SBR7
#define SCI1BDL_SBR _SCI1BDL.MergedBits.SBR

/*** SCI1CR1 - SCI Control Register 1 ***/
typedef union {
  byte Byte;
  struct {
    byte PT      :1;           /* Parity Type Bit */
...
/*** SCI1CR2 - SCI Control Register 2 ***/
typedef union {
  byte Byte;
  struct {
    byte SBK     :1;           /* Send Break Bit */
...
/*** SCI1DRH - SCI Data Register High ***/
typedef union {
  byte Byte;
  struct {
    byte         :1; 
...
typedef union {
  ...
  struct {
    ...
    byte SPE     :1;           /* SPI Interrupt Enable Bit */
...
/*** SPI0CR2 - SPI Control Register 2 ***/
typedef union {
  byte Byte;
  struct {
...
#define SPI0BR_SPR _SPI0BR.MergedBits.SPR
#define SPI0BR_SPPR _SPI0BR.MergedBits.SPPR

/*** SPI0SR - SPI Baud Rate Register ***/
typedef union {
  byte Byte;
  struct {
    byte         :1; 
...
#define SPI0DR_BIT0 _SPI0DR.Bits.BIT0
#define SPI0DR_BIT1 _SPI0DR.Bits.BIT1
#define SPI0DR_BIT2 _SPI0DR.Bits.BIT2
#define SPI0DR_BIT3 _SPI0DR.Bits.BIT3
#define SPI0DR_BIT4 _SPI0DR.Bits.BIT4
#define SPI0DR_BIT5 _SPI0DR.Bits.BIT5
#define SPI0DR_BIT6 _SPI0DR.Bits.BIT6
#define SPI0DR_BIT7 _SPI0DR.Bits.BIT7
#define SPI0DR_BIT _SPI0DR.MergedBits.BIT
...
#define IBAD_ADR_1 _IBAD.MergedBits.ADR_1
...
#define IBFD_IBC _IBFD.MergedBits.IBC
...
#define IBDR_D _IBDR.MergedBits.D

/*** SPI1CR1 - SPI Control Register ***/
typedef union {
  byte Byte;
  struct {
    byte LSBFE   :1;           /* SPI LSB-First Enable */
...
/*** SPI1CR2 - SPI Control Register 2 ***/
typedef union {
  byte Byte;
  struct {
    byte SPC0    :1;           /* Serial Pin Control Bit 0 */
...
#define SPI1BR_SPR _SPI1BR.MergedBits.SPR
#define SPI1BR_SPPR _SPI1BR.MergedBits.SPPR

/*** SPI1SR - SPI Baud Rate Register ***/
typedef union {
  byte Byte;
  struct {
    byte         :1; 
...
#define SPI1DR_BIT0 _SPI1DR.Bits.BIT0
#define SPI1DR_BIT1 _SPI1DR.Bits.BIT1
#define SPI1DR_BIT2 _SPI1DR.Bits.BIT2
#define SPI1DR_BIT3 _SPI1DR.Bits.BIT3
#define SPI1DR_BIT4 _SPI1DR.Bits.BIT4
#define SPI1DR_BIT5 _SPI1DR.Bits.BIT5
#define SPI1DR_BIT6 _SPI1DR.Bits.BIT6
#define SPI1DR_BIT7 _SPI1DR.Bits.BIT7
#define SPI1DR_BIT _SPI1DR.MergedBits.BIT

/*** SPI2CR1 - SPI Control Register ***/
typedef union {
  byte Byte;
  struct {
    byte LSBFE   :1;           /* SPI LSB-First Enable */
...
/*** SPI2CR2 - SPI Control Register 2 ***/
typedef union {
  byte Byte;
  struct {
    byte SPC0    :1;           /* Serial Pin Control Bit 0 */
...
#define SPI2BR_SPR _SPI2BR.MergedBits.SPR
#define SPI2BR_SPPR _SPI2BR.MergedBits.SPPR

/*** SPI2SR - SPI Baud Rate Register ***/
typedef union {
  byte Byte;
  struct {
    byte         :1; 
...
#define SPI2DR_BIT0 _SPI2DR.Bits.BIT0
#define SPI2DR_BIT1 _SPI2DR.Bits.BIT1
#define SPI2DR_BIT2 _SPI2DR.Bits.BIT2
#define SPI2DR_BIT3 _SPI2DR.Bits.BIT3
#define SPI2DR_BIT4 _SPI2DR.Bits.BIT4
#define SPI2DR_BIT5 _SPI2DR.Bits.BIT5
#define SPI2DR_BIT6 _SPI2DR.Bits.BIT6
#define SPI2DR_BIT7 _SPI2DR.Bits.BIT7
#define SPI2DR_BIT _SPI2DR.MergedBits.BIT
...
#define FCLKDIV_FDIV _FCLKDIV.MergedBits.FDIV
...
#define FSEC_SEC _FSEC.MergedBits.SEC
#define FSEC_NV_2 _FSEC.MergedBits.NV_2
...
#define FCNFG_BKSEL _FCNFG.MergedBits.BKSEL
...
#define FPROT_FPLS _FPROT.MergedBits.FPLS
#define FPROT_FPHS _FPROT.MergedBits.FPHS
...
#define FCMD_CMDB_5 _FCMD.MergedBits.CMDB_5
...
#define ECLKDIV_EDIV _ECLKDIV.MergedBits.EDIV
...
#define EPROT_EP _EPROT.MergedBits.EP
...
#define ECMD_CMDB_5 _ECMD.MergedBits.CMDB_5

/*** ATD1CTL2 - ATD Control Register 2 ***/
typedef union {
  byte Byte;
  struct {
    byte ASCIF   :1;           /* ATD Sequence Complete Interrupt Flag */
...
extern volatile ATD1CTL2STR _ATD1CTL2 @(REG_BASE + 0x00000122);
#define ATD1CTL2 _ATD1CTL2.Byte
#define ATD1CTL2_ASCIF _ATD1CTL2.Bits.ASCIF
#define ATD1CTL2_ASCIE _ATD1CTL2.Bits.ASCIE
#define ATD1CTL2_ETRIGE _ATD1CTL2.Bits.ETRIGE
#define ATD1CTL2_ETRIGP _ATD1CTL2.Bits.ETRIGP
#define ATD1CTL2_ETRIGLE _ATD1CTL2.Bits.ETRIGLE
#define ATD1CTL2_AWAI _ATD1CTL2.Bits.AWAI
#define ATD1CTL2_AFFC _ATD1CTL2.Bits.AFFC
#define ATD1CTL2_ADPU _ATD1CTL2.Bits.ADPU

/*** ATD1CTL3 - ATD Control Register 3 ***/
typedef union {
  byte Byte;
  struct {
    byte FRZ0    :1;           /* Background Debug Freeze Enable */
...
extern volatile ATD1CTL3STR _ATD1CTL3 @(REG_BASE + 0x00000123);
#define ATD1CTL3 _ATD1CTL3.Byte
#define ATD1CTL3_FRZ0 _ATD1CTL3.Bits.FRZ0
#define ATD1CTL3_FRZ1 _ATD1CTL3.Bits.FRZ1
#define ATD1CTL3_FIFO _ATD1CTL3.Bits.FIFO
#define ATD1CTL3_S1C _ATD1CTL3.Bits.S1C
#define ATD1CTL3_S2C _ATD1CTL3.Bits.S2C
#define ATD1CTL3_S4C _ATD1CTL3.Bits.S4C
#define ATD1CTL3_S8C _ATD1CTL3.Bits.S8C
#define ATD1CTL3_FRZ _ATD1CTL3.MergedBits.FRZ

/*** ATD1CTL4 - ATD Control Register 4 ***/
typedef union {
  byte Byte;
  struct {
    byte PRS0    :1;           /* ATD Clock Prescaler 0 */
...
extern volatile ATD1CTL4STR _ATD1CTL4 @(REG_BASE + 0x00000124);
#define ATD1CTL4 _ATD1CTL4.Byte
#define ATD1CTL4_PRS0 _ATD1CTL4.Bits.PRS0
#define ATD1CTL4_PRS1 _ATD1CTL4.Bits.PRS1
#define ATD1CTL4_PRS2 _ATD1CTL4.Bits.PRS2
#define ATD1CTL4_PRS3 _ATD1CTL4.Bits.PRS3
#define ATD1CTL4_PRS4 _ATD1CTL4.Bits.PRS4
#define ATD1CTL4_SMP0 _ATD1CTL4.Bits.SMP0
#define ATD1CTL4_SMP1 _ATD1CTL4.Bits.SMP1
#define ATD1CTL4_SRES8 _ATD1CTL4.Bits.SRES8
#define ATD1CTL4_PRS _ATD1CTL4.MergedBits.PRS
#define ATD1CTL4_SMP _ATD1CTL4.MergedBits.SMP

/*** ATD1CTL5 - ATD Control Register 5 ***/
typedef union {
  byte Byte;
  struct {
    byte CA      :1;           /* Analog Input Channel Select Code */
...
extern volatile ATD1CTL5STR _ATD1CTL5 @(REG_BASE + 0x00000125);
#define ATD1CTL5 _ATD1CTL5.Byte
#define ATD1CTL5_CA _ATD1CTL5.Bits.CA
#define ATD1CTL5_CB _ATD1CTL5.Bits.CB
#define ATD1CTL5_CC _ATD1CTL5.Bits.CC
#define ATD1CTL5_MULT _ATD1CTL5.Bits.MULT
#define ATD1CTL5_SCAN _ATD1CTL5.Bits.SCAN
#define ATD1CTL5_DSGN _ATD1CTL5.Bits.DSGN
#define ATD1CTL5_DJM _ATD1CTL5.Bits.DJM

/*** ATD1STAT0 - A/D Status Register 0 ***/
typedef union {
  byte Byte;
  struct {
    byte CC0     :1;           /* Conversion Counter 0 */
...
#define ATD1STAT0_CC _ATD1STAT0.MergedBits.CC

/*** ATD1STAT1 - A/D Status Register 1 ***/
typedef union {
  byte Byte;
  struct {
    byte CCF0    :1;           /* Conversion Complete Flag 0 */
...
#define ATD1STAT1_CCF _ATD1STAT1.MergedBits.CCF

/*** ATD1DIEN - ATD Input Enable Mask Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Disable/Enable digital input buffer */
...
#define ATD1DIEN_BIT _ATD1DIEN.MergedBits.BIT

/*** PORTAD1 - Port AD1 Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* AN0 */
...
#define PORTAD1_BIT _PORTAD1.MergedBits.BIT

/*** ATD1DR0H - A/D Conversion Result Register 0 High ***/
typedef union {
  byte Byte;
  struct {
    byte BIT8    :1;           /* Bit 8 */
...
extern volatile ATD1DR0HSTR _ATD1DR0H @(REG_BASE + 0x00000130);
#define ATD1DR0H _ATD1DR0H.Byte
#define ATD1DR0H_BIT8 _ATD1DR0H.Bits.BIT8
#define ATD1DR0H_BIT9 _ATD1DR0H.Bits.BIT9
#define ATD1DR0H_BIT10 _ATD1DR0H.Bits.BIT10
#define ATD1DR0H_BIT11 _ATD1DR0H.Bits.BIT11
#define ATD1DR0H_BIT12 _ATD1DR0H.Bits.BIT12
#define ATD1DR0H_BIT13 _ATD1DR0H.Bits.BIT13
#define ATD1DR0H_BIT14 _ATD1DR0H.Bits.BIT14
#define ATD1DR0H_BIT15 _ATD1DR0H.Bits.BIT15
#define ATD1DR0H_BIT_8 _ATD1DR0H.MergedBits.BIT_8

/*** ATD1DR0L - A/D Conversion Result Register 0 Low ***/
typedef union {
  byte Byte;
  struct {
    byte         :1; 
...
extern volatile ATD1DR0LSTR _ATD1DR0L @(REG_BASE + 0x00000131);
#define ATD1DR0L _ATD1DR0L.Byte
#define ATD1DR0L_BIT6 _ATD1DR0L.Bits.BIT6
#define ATD1DR0L_BIT7 _ATD1DR0L.Bits.BIT7
#define ATD1DR0L_BIT_6 _ATD1DR0L.MergedBits.BIT_6

/*** ATD1DR1H - A/D Conversion Result Register 1 High ***/
typedef union {
  byte Byte;
  struct {
    byte BIT8    :1;           /* Bit 8 */
...
extern volatile ATD1DR1HSTR _ATD1DR1H @(REG_BASE + 0x00000132);
#define ATD1DR1H _ATD1DR1H.Byte
#define ATD1DR1H_BIT8 _ATD1DR1H.Bits.BIT8
#define ATD1DR1H_BIT9 _ATD1DR1H.Bits.BIT9
#define ATD1DR1H_BIT10 _ATD1DR1H.Bits.BIT10
#define ATD1DR1H_BIT11 _ATD1DR1H.Bits.BIT11
#define ATD1DR1H_BIT12 _ATD1DR1H.Bits.BIT12
#define ATD1DR1H_BIT13 _ATD1DR1H.Bits.BIT13
#define ATD1DR1H_BIT14 _ATD1DR1H.Bits.BIT14
#define ATD1DR1H_BIT15 _ATD1DR1H.Bits.BIT15
#define ATD1DR1H_BIT_8 _ATD1DR1H.MergedBits.BIT_8

/*** ATD1DR1L - A/D Conversion Result Register 1 Low ***/
typedef union {
  byte Byte;
  struct {
    byte         :1; 
...
extern volatile ATD1DR1LSTR _ATD1DR1L @(REG_BASE + 0x00000133);
#define ATD1DR1L _ATD1DR1L.Byte
#define ATD1DR1L_BIT6 _ATD1DR1L.Bits.BIT6
#define ATD1DR1L_BIT7 _ATD1DR1L.Bits.BIT7
#define ATD1DR1L_BIT_6 _ATD1DR1L.MergedBits.BIT_6

/*** ATD1DR2H - A/D Conversion Result Register 2 High ***/
typedef union {
  byte Byte;
  struct {
    byte BIT8    :1;           /* Bit 8 */
...
extern volatile ATD1DR2HSTR _ATD1DR2H @(REG_BASE + 0x00000134);
#define ATD1DR2H _ATD1DR2H.Byte
#define ATD1DR2H_BIT8 _ATD1DR2H.Bits.BIT8
#define ATD1DR2H_BIT9 _ATD1DR2H.Bits.BIT9
#define ATD1DR2H_BIT10 _ATD1DR2H.Bits.BIT10
#define ATD1DR2H_BIT11 _ATD1DR2H.Bits.BIT11
#define ATD1DR2H_BIT12 _ATD1DR2H.Bits.BIT12
#define ATD1DR2H_BIT13 _ATD1DR2H.Bits.BIT13
#define ATD1DR2H_BIT14 _ATD1DR2H.Bits.BIT14
#define ATD1DR2H_BIT15 _ATD1DR2H.Bits.BIT15
#define ATD1DR2H_BIT_8 _ATD1DR2H.MergedBits.BIT_8

/*** ATD1DR2L - A/D Conversion Result Register 2 Low ***/
typedef union {
  byte Byte;
  struct {
    byte         :1; 
...
extern volatile ATD1DR2LSTR _ATD1DR2L @(REG_BASE + 0x00000135);
#define ATD1DR2L _ATD1DR2L.Byte
#define ATD1DR2L_BIT6 _ATD1DR2L.Bits.BIT6
#define ATD1DR2L_BIT7 _ATD1DR2L.Bits.BIT7
#define ATD1DR2L_BIT_6 _ATD1DR2L.MergedBits.BIT_6

/*** ATD1DR3H - A/D Conversion Result Register 3 High ***/
typedef union {
  byte Byte;
  struct {
    byte BIT8    :1;           /* Bit 8 */
...
extern volatile ATD1DR3HSTR _ATD1DR3H @(REG_BASE + 0x00000136);
#define ATD1DR3H _ATD1DR3H.Byte
#define ATD1DR3H_BIT8 _ATD1DR3H.Bits.BIT8
#define ATD1DR3H_BIT9 _ATD1DR3H.Bits.BIT9
#define ATD1DR3H_BIT10 _ATD1DR3H.Bits.BIT10
#define ATD1DR3H_BIT11 _ATD1DR3H.Bits.BIT11
#define ATD1DR3H_BIT12 _ATD1DR3H.Bits.BIT12
#define ATD1DR3H_BIT13 _ATD1DR3H.Bits.BIT13
#define ATD1DR3H_BIT14 _ATD1DR3H.Bits.BIT14
#define ATD1DR3H_BIT15 _ATD1DR3H.Bits.BIT15
#define ATD1DR3H_BIT_8 _ATD1DR3H.MergedBits.BIT_8

/*** ATD1DR3L - A/D Conversion Result Register 3 Low ***/
typedef union {
  byte Byte;
  struct {
    byte         :1; 
...
extern volatile ATD1DR3LSTR _ATD1DR3L @(REG_BASE + 0x00000137);
#define ATD1DR3L _ATD1DR3L.Byte
#define ATD1DR3L_BIT6 _ATD1DR3L.Bits.BIT6
#define ATD1DR3L_BIT7 _ATD1DR3L.Bits.BIT7
#define ATD1DR3L_BIT_6 _ATD1DR3L.MergedBits.BIT_6

/*** ATD1DR4H - A/D Conversion Result Register 4 High ***/
typedef union {
  byte Byte;
  struct {
    byte BIT8    :1;           /* Bit 8 */
...
extern volatile ATD1DR4HSTR _ATD1DR4H @(REG_BASE + 0x00000138);
#define ATD1DR4H _ATD1DR4H.Byte
#define ATD1DR4H_BIT8 _ATD1DR4H.Bits.BIT8
#define ATD1DR4H_BIT9 _ATD1DR4H.Bits.BIT9
#define ATD1DR4H_BIT10 _ATD1DR4H.Bits.BIT10
#define ATD1DR4H_BIT11 _ATD1DR4H.Bits.BIT11
#define ATD1DR4H_BIT12 _ATD1DR4H.Bits.BIT12
#define ATD1DR4H_BIT13 _ATD1DR4H.Bits.BIT13
#define ATD1DR4H_BIT14 _ATD1DR4H.Bits.BIT14
#define ATD1DR4H_BIT15 _ATD1DR4H.Bits.BIT15
#define ATD1DR4H_BIT_8 _ATD1DR4H.MergedBits.BIT_8

/*** ATD1DR4L - A/D Conversion Result Register 4 Low ***/
typedef union {
  byte Byte;
  struct {
    byte         :1; 
...
extern volatile ATD1DR4LSTR _ATD1DR4L @(REG_BASE + 0x00000139);
#define ATD1DR4L _ATD1DR4L.Byte
#define ATD1DR4L_BIT6 _ATD1DR4L.Bits.BIT6
#define ATD1DR4L_BIT7 _ATD1DR4L.Bits.BIT7
#define ATD1DR4L_BIT_6 _ATD1DR4L.MergedBits.BIT_6

/*** ATD1DR5H - A/D Conversion Result Register 5 High ***/
typedef union {
  byte Byte;
  struct {
    byte BIT8    :1;           /* Bit 8 */
...
extern volatile ATD1DR5HSTR _ATD1DR5H @(REG_BASE + 0x0000013A);
#define ATD1DR5H _ATD1DR5H.Byte
#define ATD1DR5H_BIT8 _ATD1DR5H.Bits.BIT8
#define ATD1DR5H_BIT9 _ATD1DR5H.Bits.BIT9
#define ATD1DR5H_BIT10 _ATD1DR5H.Bits.BIT10
#define ATD1DR5H_BIT11 _ATD1DR5H.Bits.BIT11
#define ATD1DR5H_BIT12 _ATD1DR5H.Bits.BIT12
#define ATD1DR5H_BIT13 _ATD1DR5H.Bits.BIT13
#define ATD1DR5H_BIT14 _ATD1DR5H.Bits.BIT14
#define ATD1DR5H_BIT15 _ATD1DR5H.Bits.BIT15
#define ATD1DR5H_BIT_8 _ATD1DR5H.MergedBits.BIT_8

/*** ATD1DR5L - A/D Conversion Result Register 5 Low ***/
typedef union {
  byte Byte;
  struct {
    byte         :1; 
...
extern volatile ATD1DR5LSTR _ATD1DR5L @(REG_BASE + 0x0000013B);
#define ATD1DR5L _ATD1DR5L.Byte
#define ATD1DR5L_BIT6 _ATD1DR5L.Bits.BIT6
#define ATD1DR5L_BIT7 _ATD1DR5L.Bits.BIT7
#define ATD1DR5L_BIT_6 _ATD1DR5L.MergedBits.BIT_6

/*** ATD1DR6H - A/D Conversion Result Register 6 High ***/
typedef union {
  byte Byte;
  struct {
    byte BIT8    :1;           /* Bit 8 */
...
extern volatile ATD1DR6HSTR _ATD1DR6H @(REG_BASE + 0x0000013C);
#define ATD1DR6H _ATD1DR6H.Byte
#define ATD1DR6H_BIT8 _ATD1DR6H.Bits.BIT8
#define ATD1DR6H_BIT9 _ATD1DR6H.Bits.BIT9
#define ATD1DR6H_BIT10 _ATD1DR6H.Bits.BIT10
#define ATD1DR6H_BIT11 _ATD1DR6H.Bits.BIT11
#define ATD1DR6H_BIT12 _ATD1DR6H.Bits.BIT12
#define ATD1DR6H_BIT13 _ATD1DR6H.Bits.BIT13
#define ATD1DR6H_BIT14 _ATD1DR6H.Bits.BIT14
#define ATD1DR6H_BIT15 _ATD1DR6H.Bits.BIT15
#define ATD1DR6H_BIT_8 _ATD1DR6H.MergedBits.BIT_8

/*** ATD1DR6L - A/D Conversion Result Register 6 Low ***/
typedef union {
  byte Byte;
  struct {
    byte         :1; 
...
extern volatile ATD1DR6LSTR _ATD1DR6L @(REG_BASE + 0x0000013D);
#define ATD1DR6L _ATD1DR6L.Byte
#define ATD1DR6L_BIT6 _ATD1DR6L.Bits.BIT6
#define ATD1DR6L_BIT7 _ATD1DR6L.Bits.BIT7
#define ATD1DR6L_BIT_6 _ATD1DR6L.MergedBits.BIT_6

/*** ATD1DR7H - A/D Conversion Result Register 7 High ***/
typedef union {
  byte Byte;
  struct {
    byte BIT8    :1;           /* Bit 8 */
...
extern volatile ATD1DR7HSTR _ATD1DR7H @(REG_BASE + 0x0000013E);
#define ATD1DR7H _ATD1DR7H.Byte
#define ATD1DR7H_BIT8 _ATD1DR7H.Bits.BIT8
#define ATD1DR7H_BIT9 _ATD1DR7H.Bits.BIT9
#define ATD1DR7H_BIT10 _ATD1DR7H.Bits.BIT10
#define ATD1DR7H_BIT11 _ATD1DR7H.Bits.BIT11
#define ATD1DR7H_BIT12 _ATD1DR7H.Bits.BIT12
#define ATD1DR7H_BIT13 _ATD1DR7H.Bits.BIT13
#define ATD1DR7H_BIT14 _ATD1DR7H.Bits.BIT14
#define ATD1DR7H_BIT15 _ATD1DR7H.Bits.BIT15
#define ATD1DR7H_BIT_8 _ATD1DR7H.MergedBits.BIT_8

/*** ATD1DR7L - A/D Conversion Result Register 7 Low ***/
typedef union {
  byte Byte;
  struct {
    byte         :1; 
...
extern volatile ATD1DR7LSTR _ATD1DR7L @(REG_BASE + 0x0000013F);
#define ATD1DR7L _ATD1DR7L.Byte
#define ATD1DR7L_BIT6 _ATD1DR7L.Bits.BIT6
#define ATD1DR7L_BIT7 _ATD1DR7L.Bits.BIT7
#define ATD1DR7L_BIT_6 _ATD1DR7L.MergedBits.BIT_6
...
#define CAN0BTR0_BRP _CAN0BTR0.MergedBits.BRP
#define CAN0BTR0_SJW _CAN0BTR0.MergedBits.SJW
...
#define CAN0BTR1_TSEG1 _CAN0BTR1.MergedBits.TSEG1
#define CAN0BTR1_TSEG2 _CAN0BTR1.MergedBits.TSEG2

/*** CAN0RFLG - MSCAN Receiver Flag Register ***/
typedef union {
  byte Byte;
  struct {
...
#define CAN0RFLG_TSTAT _CAN0RFLG.MergedBits.TSTAT
#define CAN0RFLG_RSTAT _CAN0RFLG.MergedBits.RSTAT
...
#define CAN0RIER_TSTATE _CAN0RIER.MergedBits.TSTATE
#define CAN0RIER_RSTATE _CAN0RIER.MergedBits.RSTATE

/*** CAN0TFLG - MSCAN Transmitter Flag Register ***/
typedef union {
  byte Byte;
  struct {
...
#define CAN0TFLG_TXE _CAN0TFLG.MergedBits.TXE

/*** CAN0TIER - MSCAN Transmitter Interrupt Enable Register ***/
typedef union {
  byte Byte;
  struct {
...
#define CAN0TIER_TXEIE _CAN0TIER.MergedBits.TXEIE

/*** CAN0TARQ - MSCAN Transmitter Message Abort Control ***/
typedef union {
  byte Byte;
  struct {
...
#define CAN0TARQ_ABTRQ _CAN0TARQ.MergedBits.ABTRQ

/*** CAN0TAAK - MSCAN Transmitter Message Abort Control ***/
typedef union {
  byte Byte;
  struct {
...
#define CAN0TAAK_ABTAK _CAN0TAAK.MergedBits.ABTAK

/*** CAN0TBSEL - MSCAN Transmit Buffer Selection ***/
typedef union {
  byte Byte;
  struct {
...
#define CAN0TBSEL_TX _CAN0TBSEL.MergedBits.TX
...
#define CAN0IDAC_IDHIT _CAN0IDAC.MergedBits.IDHIT
#define CAN0IDAC_IDAM _CAN0IDAC.MergedBits.IDAM
...
#define CAN0RXERR_RXERR _CAN0RXERR.MergedBits.RXERR

/*** CAN0TXERR - MSCAN Transmit Error Counter Register ***/
typedef union {
  byte Byte;
  struct {
    byte TXERR0  :1;           /* Bit 0 */
...
#define CAN0TXERR_TXERR _CAN0TXERR.MergedBits.TXERR

/*** CAN0IDAR0 - MSCAN Identifier Acceptance Register 0 ***/
typedef union {
  byte Byte;
  struct {
...
#define CAN0IDAR0_AC _CAN0IDAR0.MergedBits.AC

/*** CAN0IDAR1 - MSCAN Identifier Acceptance Register 1 ***/
typedef union {
  byte Byte;
  struct {
    byte AC0     :1;           /* Acceptance Code Bit 0 */
...
#define CAN0IDAR1_AC _CAN0IDAR1.MergedBits.AC

/*** CAN0IDAR2 - MSCAN Identifier Acceptance Register 2 ***/
typedef union {
  byte Byte;
  struct {
    byte AC0     :1;           /* Acceptance Code Bit 0 */
...
#define CAN0IDAR2_AC _CAN0IDAR2.MergedBits.AC

/*** CAN0IDAR3 - MSCAN Identifier Acceptance Register 3 ***/
typedef union {
  byte Byte;
  struct {
    byte AC0     :1;           /* Acceptance Code Bit 0 */
...
#define CAN0IDAR3_AC _CAN0IDAR3.MergedBits.AC

/*** CAN0IDMR0 - MSCAN Identifier Mask Register 0 ***/
typedef union {
  byte Byte;
  struct {
...
#define CAN0IDMR0_AM _CAN0IDMR0.MergedBits.AM

/*** CAN0IDMR1 - MSCAN Identifier Mask Register 1 ***/
typedef union {
  byte Byte;
  struct {
    byte AM0     :1;           /* Acceptance Mask Bit 0 */
...
#define CAN0IDMR1_AM _CAN0IDMR1.MergedBits.AM

/*** CAN0IDMR2 - MSCAN Identifier Mask Register 2 ***/
typedef union {
  byte Byte;
  struct {
    byte AM0     :1;           /* Acceptance Mask Bit 0 */
...
#define CAN0IDMR2_AM _CAN0IDMR2.MergedBits.AM

/*** CAN0IDMR3 - MSCAN Identifier Mask Register 3 ***/
typedef union {
  byte Byte;
  struct {
    byte AM0     :1;           /* Acceptance Mask Bit 0 */
...
#define CAN0IDMR3_AM _CAN0IDMR3.MergedBits.AM

/*** CAN0IDAR4 - MSCAN Identifier Acceptance Register 4 ***/
typedef union {
  byte Byte;
  struct {
    byte AC0     :1;           /* Acceptance Code Bit 0 */
...
#define CAN0IDAR4_AC _CAN0IDAR4.MergedBits.AC

/*** CAN0IDAR5 - MSCAN Identifier Acceptance Register 5 ***/
typedef union {
  byte Byte;
  struct {
    byte AC0     :1;           /* Acceptance Code Bit 0 */
...
#define CAN0IDAR5_AC _CAN0IDAR5.MergedBits.AC

/*** CAN0IDAR6 - MSCAN Identifier Acceptance Register 6 ***/
typedef union {
  byte Byte;
  struct {
    byte AC0     :1;           /* Acceptance Code Bit 0 */
...
#define CAN0IDAR6_AC _CAN0IDAR6.MergedBits.AC

/*** CAN0IDAR7 - MSCAN Identifier Acceptance Register 7 ***/
typedef union {
  byte Byte;
  struct {
    byte AC0     :1;           /* Acceptance Code Bit 0 */
...
#define CAN0IDAR7_AC _CAN0IDAR7.MergedBits.AC

/*** CAN0IDMR4 - MSCAN Identifier Mask Register 4 ***/
typedef union {
  byte Byte;
  struct {
    byte AM0     :1;           /* Acceptance Mask Bit 0 */
...
#define CAN0IDMR4_AM _CAN0IDMR4.MergedBits.AM

/*** CAN0IDMR5 - MSCAN Identifier Mask Register 5 ***/
typedef union {
  byte Byte;
  struct {
    byte AM0     :1;           /* Acceptance Mask Bit 0 */
...
#define CAN0IDMR5_AM _CAN0IDMR5.MergedBits.AM

/*** CAN0IDMR6 - MSCAN Identifier Mask Register 6 ***/
typedef union {
  byte Byte;
  struct {
    byte AM0     :1;           /* Acceptance Mask Bit 0 */
...
#define CAN0IDMR6_AM _CAN0IDMR6.MergedBits.AM

/*** CAN0IDMR7 - MSCAN Identifier Mask Register 7 ***/
typedef union {
  byte Byte;
  struct {
    byte AM0     :1;           /* Acceptance Mask Bit 0 */
...
#define CAN0IDMR7_AM _CAN0IDMR7.MergedBits.AM

/*** CAN0RXIDR0 - MSCAN Identifier Register 0 ***/
typedef union {
  byte Byte;
  struct {
...
#define CAN0RXIDR0_ID2_1 _CAN0RXIDR0.MergedBits.ID2_1

/*** CAN0RXIDR1 - MSCAN Identifier Register 1 ***/
typedef union {
  byte Byte;
  struct {
...
#define CAN0RXIDR1_ID1_5 _CAN0RXIDR1.MergedBits.ID1_5
#define CAN0RXIDR1_ID1_8 _CAN0RXIDR1.MergedBits.ID1_8

/*** CAN0RXIDR2 - MSCAN Identifier Register 2 ***/
typedef union {
  byte Byte;
  struct {
...
#define CAN0RXIDR2_ID_7 _CAN0RXIDR2.MergedBits.ID_7

/*** CAN0RXIDR3 - MSCAN Identifier Register 0 ***/
typedef union {
  byte Byte;
  struct {
...
#define CAN0RXIDR3_ID _CAN0RXIDR3.MergedBits.ID

/*** CAN0RXDSR0 - MSCAN Data Segment Register 0 ***/
typedef union {
  byte Byte;
  struct {
...
#define CAN0RXDSR0_DB _CAN0RXDSR0.MergedBits.DB

/*** CAN0RXDSR1 - MSCAN Data Segment Register 1 ***/
typedef union {
  byte Byte;
  struct {
    byte DB0     :1;           /* Data Bit 0 */
...
#define CAN0RXDSR1_DB _CAN0RXDSR1.MergedBits.DB

/*** CAN0RXDSR2 - MSCAN Data Segment Register 2 ***/
typedef union {
  byte Byte;
  struct {
    byte DB0     :1;           /* Data Bit 0 */
...
#define CAN0RXDSR2_DB _CAN0RXDSR2.MergedBits.DB

/*** CAN0RXDSR3 - MSCAN Data Segment Register 3 ***/
typedef union {
  byte Byte;
  struct {
    byte DB0     :1;           /* Data Bit 0 */
...
#define CAN0RXDSR3_DB _CAN0RXDSR3.MergedBits.DB

/*** CAN0RXDSR4 - MSCAN Data Segment Register 4 ***/
typedef union {
  byte Byte;
  struct {
    byte DB0     :1;           /* Data Bit 0 */
...
#define CAN0RXDSR4_DB _CAN0RXDSR4.MergedBits.DB

/*** CAN0RXDSR5 - MSCAN Data Segment Register 5 ***/
typedef union {
  byte Byte;
  struct {
    byte DB0     :1;           /* Data Bit 0 */
...
#define CAN0RXDSR5_DB _CAN0RXDSR5.MergedBits.DB

/*** CAN0RXDSR6 - MSCAN Data Segment Register 6 ***/
typedef union {
  byte Byte;
  struct {
    byte DB0     :1;           /* Data Bit 0 */
...
#define CAN0RXDSR6_DB _CAN0RXDSR6.MergedBits.DB

/*** CAN0RXDSR7 - MSCAN Data Segment Register 7 ***/
typedef union {
  byte Byte;
  struct {
    byte DB0     :1;           /* Data Bit 0 */
...
#define CAN0RXDSR7_DB _CAN0RXDSR7.MergedBits.DB

/*** CAN0RXDLR - MSCAN Data Length Register ***/
typedef union {
  byte Byte;
  struct {
...
#define CAN0RXDLR_DLC _CAN0RXDLR.MergedBits.DLC

/*** CAN0TXIDR0 - MSCAN Identifier Register 0 ***/
typedef union {
  byte Byte;
  struct {
    byte ID21    :1;           /* Extended format identifier Bit 21 */
...
#define CAN0TXIDR0_ID2_1 _CAN0TXIDR0.MergedBits.ID2_1

/*** CAN0TXIDR1 - MSCAN Identifier Register 1 ***/
typedef union {
  byte Byte;
  struct {
    byte ID15    :1;           /* Extended format identifier Bit 15 */
...
#define CAN0TXIDR1_ID1_5 _CAN0TXIDR1.MergedBits.ID1_5
#define CAN0TXIDR1_ID1_8 _CAN0TXIDR1.MergedBits.ID1_8

/*** CAN0TXIDR2 - MSCAN Identifier Register 2 ***/
typedef union {
  byte Byte;
  struct {
    byte ID7     :1;           /* Extended format identifier Bit 7 */
...
#define CAN0TXIDR2_ID_7 _CAN0TXIDR2.MergedBits.ID_7

/*** CAN0TXIDR3 - MSCAN Identifier Register 0 ***/
typedef union {
  byte Byte;
  struct {
    byte RTR     :1;           /* Remote Transmission Request */
...
#define CAN0TXIDR3_ID _CAN0TXIDR3.MergedBits.ID

/*** CAN0TXDSR0 - MSCAN Data Segment Register 0 ***/
typedef union {
  byte Byte;
  struct {
    byte DB0     :1;           /* Data Bit 0 */
...
#define CAN0TXDSR0_DB _CAN0TXDSR0.MergedBits.DB

/*** CAN0TXDSR1 - MSCAN Data Segment Register 1 ***/
typedef union {
  byte Byte;
  struct {
    byte DB0     :1;           /* Data Bit 0 */
...
#define CAN0TXDSR1_DB _CAN0TXDSR1.MergedBits.DB

/*** CAN0TXDSR2 - MSCAN Data Segment Register 2 ***/
typedef union {
  byte Byte;
  struct {
    byte DB0     :1;           /* Data Bit 0 */
...
#define CAN0TXDSR2_DB _CAN0TXDSR2.MergedBits.DB

/*** CAN0TXDSR3 - MSCAN Data Segment Register 3 ***/
typedef union {
  byte Byte;
  struct {
    byte DB0     :1;           /* Data Bit 0 */
...
#define CAN0TXDSR3_DB _CAN0TXDSR3.MergedBits.DB

/*** CAN0TXDSR4 - MSCAN Data Segment Register 4 ***/
typedef union {
  byte Byte;
  struct {
    byte DB0     :1;           /* Data Bit 0 */
...
#define CAN0TXDSR4_DB _CAN0TXDSR4.MergedBits.DB

/*** CAN0TXDSR5 - MSCAN Data Segment Register 5 ***/
typedef union {
  byte Byte;
  struct {
    byte DB0     :1;           /* Data Bit 0 */
...
#define CAN0TXDSR5_DB _CAN0TXDSR5.MergedBits.DB

/*** CAN0TXDSR6 - MSCAN Data Segment Register 6 ***/
typedef union {
  byte Byte;
  struct {
    byte DB0     :1;           /* Data Bit 0 */
...
#define CAN0TXDSR6_DB _CAN0TXDSR6.MergedBits.DB

/*** CAN0TXDSR7 - MSCAN Data Segment Register 7 ***/
typedef union {
  byte Byte;
  struct {
    byte DB0     :1;           /* Data Bit 0 */
...
#define CAN0TXDSR7_DB _CAN0TXDSR7.MergedBits.DB

/*** CAN0TXDLR - MSCAN Data Length Register ***/
typedef union {
  byte Byte;
  struct {
    byte DLC0    :1;           /* Data Length Code Bit 0 */
...
#define CAN0TXDLR_DLC _CAN0TXDLR.MergedBits.DLC

/*** CAN0TXTBPR - MSCAN Transmit Buffer Priority ***/
typedef union {
  byte Byte;
  struct {
...
#define CAN0TXTBPR_PRIO _CAN0TXTBPR.MergedBits.PRIO
...
#define PTT_PTT _PTT.MergedBits.PTT
...
#define PTIT_PTIT _PTIT.MergedBits.PTIT

/*** DDRT - Port S Data Direction Register ***/
typedef union {
  byte Byte;
  struct {
...
#define DDRT_DDRT _DDRT.MergedBits.DDRT

/*** RDRT - Port S Reduced Drive Register ***/
typedef union {
  byte Byte;
  struct {
...
#define RDRT_RDRT _RDRT.MergedBits.RDRT

/*** PERT - Port H Pull Device Enable Register ***/
typedef union {
  byte Byte;
  struct {
...
#define PERT_PERT _PERT.MergedBits.PERT
...
#define PPST_PPST _PPST.MergedBits.PPST

/*** PTS - Port S Polarity Select Register ***/
typedef union {
  byte Byte;
  struct {
    byte PTS0    :1;           /* Port S Bit 0, SS0 */
    byte PTS1    :1;           /* Port S Bit 1, SCK0 */
    byte PTS2    :1;           /* Port S Bit 2, MOSI0 */
    byte PTS3    :1;           /* Port S Bit 3, MISO0 */
    byte PTS4    :1;           /* Port S Bit 4, TxD1 */
    byte PTS5    :1;           /* Port S Bit 5, RxD1 */
    byte PTS6    :1;           /* Port S Bit 6, TxD0 */
    byte PTS7    :1;           /* Port S Bit 7, RxD0 */
  } Bits;
  struct {
    byte PTS     :8;
  } MergedBits;
...
#define PTS_PTS _PTS.MergedBits.PTS
...
#define PTIS_PTIS _PTIS.MergedBits.PTIS
...
#define DDRS_DDRS _DDRS.MergedBits.DDRS
...
#define RDRS_RDRS _RDRS.MergedBits.RDRS
...
#define PERS_PERS _PERS.MergedBits.PERS
...
#define PPSS_PPSS _PPSS.MergedBits.PPSS
...
#define WOMS_WOMS _WOMS.MergedBits.WOMS

/*** PTM - Port M I/O Register ***/
typedef union {
  byte Byte;
  struct {
    byte PTM0    :1;           /* Port T Bit 0, RxCAN0, RxBDLC */
    byte PTM1    :1;           /* Port T Bit 1, TxCAN0, TxBDLC */
    byte PTM2    :1;           /* Port T Bit 2, RxCAN1 */
    byte PTM3    :1;           /* Port T Bit 3, TxCAN1 */
    byte PTM4    :1;           /* Port T Bit 4, RxCAN2 */
    byte PTM5    :1;           /* Port T Bit 5, TxCAN2 */
    byte PTM6    :1;           /* Port T Bit 6, RxCAN3 */
    byte PTM7    :1;           /* Port T Bit 7, TxCAN3 */
  } Bits;
  struct {
    byte PTM     :8;
  } MergedBits;
...
#define PTM_PTM _PTM.MergedBits.PTM
...
#define PTIM_PTIM _PTIM.MergedBits.PTIM
...
#define DDRM_DDRM _DDRM.MergedBits.DDRM
...
#define RDRM_RDRM _RDRM.MergedBits.RDRM
...
#define PERM_PERM _PERM.MergedBits.PERM
...
#define PPSM_PPSM _PPSM.MergedBits.PPSM

/*** WOMM - Port M Polarity Select Register ***/
typedef union {
  byte Byte;
  struct {
...
#define WOMM_WOMM _WOMM.MergedBits.WOMM

/*** MODRR - Module Routing Register ***/
typedef union {
  byte Byte;
  struct {
...
#define MODRR_MODRR _MODRR.MergedBits.MODRR

/*** PTP - Port P I/O Register ***/
typedef union {
  byte Byte;
  struct {
    byte PTP0    :1;           /* Port P Bit 0, PWM0, MISO1 */
    byte PTP1    :1;           /* Port P Bit 1, PWM1, MOSI1 */
    byte PTP2    :1;           /* Port P Bit 2, PWM2, SCK1 */
    byte PTP3    :1;           /* Port P Bit 3, PWM3, SS1 */
    byte PTP4    :1;           /* Port P Bit 4, PWM4, MISO2 */
    byte PTP5    :1;           /* Port P Bit 5, PWM5, MOSI2 */
    byte PTP6    :1;           /* Port P Bit 6, PWM6, SS2 */
    byte PTP7    :1;           /* Port P Bit 7, PWM7, SCK2 */
  } Bits;
  struct {
    byte PTP     :8;
  } MergedBits;
...
#define PTP_PTP _PTP.MergedBits.PTP
...
#define PTIP_PTIP _PTIP.MergedBits.PTIP
...
#define DDRP_DDRP _DDRP.MergedBits.DDRP
...
#define RDRP_RDRP _RDRP.MergedBits.RDRP
...
#define PERP_PERP _PERP.MergedBits.PERP
...
#define PPSP_PPSP _PPSP.MergedBits.PPSP
...
#define PIEP_PIEP _PIEP.MergedBits.PIEP
...
#define PIFP_PIFP _PIFP.MergedBits.PIFP
...
#define PTH_PTH _PTH.MergedBits.PTH
...
#define PTIH_PTIH _PTIH.MergedBits.PTIH
...
#define DDRH_DDRH _DDRH.MergedBits.DDRH
...
#define RDRH_RDRH _RDRH.MergedBits.RDRH
...
#define PERH_PERH _PERH.MergedBits.PERH
...
#define PPSH_PPSH _PPSH.MergedBits.PPSH
...
#define PIEH_PIEH _PIEH.MergedBits.PIEH
...
#define PIFH_PIFH _PIFH.MergedBits.PIFH
...
typedef union {
  ...
  struct {
    ...
    byte         :1; 
    byte         :1; 
    byte PTJ6    :1;           /* Port J Bit 6, RxCAN4, SDA */
    byte PTJ7    :1;           /* Port J Bit 7, TxCAN4, SCL */
  } Bits;
  struct {
    byte PTJ     :2;
    byte         :1;
...
#define PTJ_PTJ _PTJ.MergedBits.PTJ
#define PTJ_PTJ_6 _PTJ.MergedBits.PTJ_6
...
#define PTIJ_PTIJ _PTIJ.MergedBits.PTIJ
#define PTIJ_PTIJ_6 _PTIJ.MergedBits.PTIJ_6
...
#define DDRJ_DDRJ _DDRJ.MergedBits.DDRJ
#define DDRJ_DDRJ_6 _DDRJ.MergedBits.DDRJ_6
...
#define RDRJ_RDRJ _RDRJ.MergedBits.RDRJ
#define RDRJ_RDRJ_6 _RDRJ.MergedBits.RDRJ_6
...
#define PERJ_PERJ _PERJ.MergedBits.PERJ
#define PERJ_PERJ_6 _PERJ.MergedBits.PERJ_6

/*** PPSJ - PortJP Polarity Select Register ***/
typedef union {
  byte Byte;
  struct {
...
#define PPSJ_PPSJ _PPSJ.MergedBits.PPSJ
#define PPSJ_PPSJ_6 _PPSJ.MergedBits.PPSJ_6
...
#define PIEJ_PIEJ _PIEJ.MergedBits.PIEJ
#define PIEJ_PIEJ_6 _PIEJ.MergedBits.PIEJ_6
...
#define PIFJ_PIFJ _PIFJ.MergedBits.PIFJ
#define PIFJ_PIFJ_6 _PIFJ.MergedBits.PIFJ_6

/*** CAN4CTL0 - MSCAN Control 0 Register ***/
typedef union {
  byte Byte;
  struct {
    byte INITRQ  :1;           /* Initialization Mode Request */
...
/*** CAN4CTL1 - MSCAN Control 1 Register ***/
typedef union {
  byte Byte;
  struct {
    byte INITAK  :1;           /* Initialization Mode Acknowledge */
...
/*** CAN4BTR0 - MSCAN Bus Timing Register 0 ***/
typedef union {
  byte Byte;
  struct {
    byte BRP0    :1;           /* Baud Rate Prescaler 0 */
...
#define CAN4BTR0_BRP _CAN4BTR0.MergedBits.BRP
#define CAN4BTR0_SJW _CAN4BTR0.MergedBits.SJW

/*** CAN4BTR1 - MSCAN Bus Timing Register 1 ***/
typedef union {
  byte Byte;
  struct {
    byte TSEG10  :1;           /* Time Segment 1 */
...
#define CAN4BTR1_TSEG1 _CAN4BTR1.MergedBits.TSEG1
#define CAN4BTR1_TSEG2 _CAN4BTR1.MergedBits.TSEG2

/*** CAN4RFLG - MSCAN Receiver Flag Register ***/
typedef union {
  byte Byte;
  struct {
    byte RXF     :1;           /* Receive Buffer Full */
...
#define CAN4RFLG_TSTAT _CAN4RFLG.MergedBits.TSTAT
#define CAN4RFLG_RSTAT _CAN4RFLG.MergedBits.RSTAT

/*** CAN4RIER - MSCAN Receiver Interrupt Enable Register ***/
typedef union {
  byte Byte;
  struct {
    byte RXFIE   :1;           /* Receiver Full Interrupt Enable */
...
#define CAN4RIER_TSTATE _CAN4RIER.MergedBits.TSTATE
#define CAN4RIER_RSTATE _CAN4RIER.MergedBits.RSTATE

/*** CAN4TFLG - MSCAN Transmitter Flag Register ***/
typedef union {
  byte Byte;
  struct {
    byte TXE0    :1;           /* Transmitter Buffer Empty 0 */
...
#define CAN4TFLG_TXE _CAN4TFLG.MergedBits.TXE

/*** CAN4TIER - MSCAN Transmitter Interrupt Enable Register ***/
typedef union {
  byte Byte;
  struct {
    byte TXEIE0  :1;           /* Transmitter Empty Interrupt Enable 0 */
...
#define CAN4TIER_TXEIE _CAN4TIER.MergedBits.TXEIE

/*** CAN4TARQ - MSCAN Transmitter Message Abort Control ***/
typedef union {
  byte Byte;
  struct {
    byte ABTRQ0  :1;           /* Abort Request 0 */
...
#define CAN4TARQ_ABTRQ _CAN4TARQ.MergedBits.ABTRQ

/*** CAN4TAAK - MSCAN Transmitter Message Abort Control ***/
typedef union {
  byte Byte;
  struct {
    byte ABTAK0  :1;           /* Abort Acknowledge 0 */
...
#define CAN4TAAK_ABTAK _CAN4TAAK.MergedBits.ABTAK

/*** CAN4TBSEL - MSCAN Transmit Buffer Selection ***/
typedef union {
  byte Byte;
  struct {
    byte TX0     :1;           /* Transmit Buffer Select 0 */
...
#define CAN4TBSEL_TX _CAN4TBSEL.MergedBits.TX

/*** CAN4IDAC - MSCAN Identifier Acceptance Control Register ***/
typedef union {
  byte Byte;
  struct {
    byte IDHIT0  :1;           /* Identifier Acceptance Hit Indicator 0 */
...
#define CAN4IDAC_IDHIT _CAN4IDAC.MergedBits.IDHIT
#define CAN4IDAC_IDAM _CAN4IDAC.MergedBits.IDAM

/*** CAN4RXERR - MSCAN Receive Error Counter Register ***/
typedef union {
  byte Byte;
  struct {
    byte RXERR0  :1;           /* Bit 0 */
...
#define CAN4RXERR_RXERR _CAN4RXERR.MergedBits.RXERR

/*** CAN4TXERR - MSCAN Transmit Error Counter Register ***/
typedef union {
  byte Byte;
  struct {
    byte TXERR0  :1;           /* Bit 0 */
...
#define CAN4TXERR_TXERR _CAN4TXERR.MergedBits.TXERR

/*** CAN4IDAR0 - MSCAN Identifier Acceptance Register 0 ***/
typedef union {
  byte Byte;
  struct {
    byte AC0     :1;           /* Acceptance Code Bit 0 */
...
#define CAN4IDAR0_AC _CAN4IDAR0.MergedBits.AC

/*** CAN4IDAR1 - MSCAN Identifier Acceptance Register 1 ***/
typedef union {
  byte Byte;
  struct {
    byte AC0     :1;           /* Acceptance Code Bit 0 */
...
#define CAN4IDAR1_AC _CAN4IDAR1.MergedBits.AC

/*** CAN4IDAR2 - MSCAN Identifier Acceptance Register 2 ***/
typedef union {
  byte Byte;
  struct {
    byte AC0     :1;           /* Acceptance Code Bit 0 */
...
#define CAN4IDAR2_AC _CAN4IDAR2.MergedBits.AC

/*** CAN4IDAR3 - MSCAN Identifier Acceptance Register 3 ***/
typedef union {
  byte Byte;
  struct {
    byte AC0     :1;           /* Acceptance Code Bit 0 */
...
#define CAN4IDAR3_AC _CAN4IDAR3.MergedBits.AC

/*** CAN4IDMR0 - MSCAN Identifier Mask Register 0 ***/
typedef union {
  byte Byte;
  struct {
    byte AM0     :1;           /* Acceptance Mask Bit 0 */
...
#define CAN4IDMR0_AM _CAN4IDMR0.MergedBits.AM

/*** CAN4IDMR1 - MSCAN Identifier Mask Register 1 ***/
typedef union {
  byte Byte;
  struct {
    byte AM0     :1;           /* Acceptance Mask Bit 0 */
...
#define CAN4IDMR1_AM _CAN4IDMR1.MergedBits.AM

/*** CAN4IDMR2 - MSCAN Identifier Mask Register 2 ***/
typedef union {
  byte Byte;
  struct {
    byte AM0     :1;           /* Acceptance Mask Bit 0 */
...
#define CAN4IDMR2_AM _CAN4IDMR2.MergedBits.AM

/*** CAN4IDMR3 - MSCAN Identifier Mask Register 3 ***/
typedef union {
  byte Byte;
  struct {
    byte AM0     :1;           /* Acceptance Mask Bit 0 */
...
#define CAN4IDMR3_AM _CAN4IDMR3.MergedBits.AM

/*** CAN4IDAR4 - MSCAN Identifier Acceptance Register 4 ***/
typedef union {
  byte Byte;
  struct {
    byte AC0     :1;           /* Acceptance Code Bit 0 */
...
#define CAN4IDAR4_AC _CAN4IDAR4.MergedBits.AC

/*** CAN4IDAR5 - MSCAN Identifier Acceptance Register 5 ***/
typedef union {
  byte Byte;
  struct {
    byte AC0     :1;           /* Acceptance Code Bit 0 */
...
#define CAN4IDAR5_AC _CAN4IDAR5.MergedBits.AC

/*** CAN4IDAR6 - MSCAN Identifier Acceptance Register 6 ***/
typedef union {
  byte Byte;
  struct {
    byte AC0     :1;           /* Acceptance Code Bit 0 */
...
#define CAN4IDAR6_AC _CAN4IDAR6.MergedBits.AC

/*** CAN4IDAR7 - MSCAN Identifier Acceptance Register 7 ***/
typedef union {
  byte Byte;
  struct {
    byte AC0     :1;           /* Acceptance Code Bit 0 */
...
#define CAN4IDAR7_AC _CAN4IDAR7.MergedBits.AC

/*** CAN4IDMR4 - MSCAN Identifier Mask Register 4 ***/
typedef union {
  byte Byte;
  struct {
    byte AM0     :1;           /* Acceptance Mask Bit 0 */
...
#define CAN4IDMR4_AM _CAN4IDMR4.MergedBits.AM

/*** CAN4IDMR5 - MSCAN Identifier Mask Register 5 ***/
typedef union {
  byte Byte;
  struct {
    byte AM0     :1;           /* Acceptance Mask Bit 0 */
...
#define CAN4IDMR5_AM _CAN4IDMR5.MergedBits.AM

/*** CAN4IDMR6 - MSCAN Identifier Mask Register 6 ***/
typedef union {
  byte Byte;
  struct {
    byte AM0     :1;           /* Acceptance Mask Bit 0 */
...
#define CAN4IDMR6_AM _CAN4IDMR6.MergedBits.AM

/*** CAN4IDMR7 - MSCAN Identifier Mask Register 7 ***/
typedef union {
  byte Byte;
  struct {
    byte AM0     :1;           /* Acceptance Mask Bit 0 */
...
#define CAN4IDMR7_AM _CAN4IDMR7.MergedBits.AM

/*** CAN4RXIDR0 - MSCAN Identifier Register 0 ***/
typedef union {
  byte Byte;
  struct {
    byte ID21    :1;           /* Extended format identifier Bit 21 */
...
#define CAN4RXIDR0_ID2_1 _CAN4RXIDR0.MergedBits.ID2_1

/*** CAN4RXIDR1 - MSCAN Identifier Register 1 ***/
typedef union {
  byte Byte;
  struct {
    byte ID15    :1;           /* Extended format identifier Bit 15 */
...
#define CAN4RXIDR1_ID1_5 _CAN4RXIDR1.MergedBits.ID1_5
#define CAN4RXIDR1_ID1_8 _CAN4RXIDR1.MergedBits.ID1_8

/*** CAN4RXIDR2 - MSCAN Identifier Register 2 ***/
typedef union {
  byte Byte;
  struct {
    byte ID7     :1;           /* Extended format identifier Bit 7 */
...
#define CAN4RXIDR2_ID_7 _CAN4RXIDR2.MergedBits.ID_7

/*** CAN4RXIDR3 - MSCAN Identifier Register 0 ***/
typedef union {
  byte Byte;
  struct {
    byte RTR     :1;           /* Remote Transmission Request */
...
#define CAN4RXIDR3_ID _CAN4RXIDR3.MergedBits.ID

/*** CAN4RXDSR0 - MSCAN Data Segment Register 0 ***/
typedef union {
  byte Byte;
  struct {
    byte DB0     :1;           /* Data Bit 0 */
...
#define CAN4RXDSR0_DB _CAN4RXDSR0.MergedBits.DB

/*** CAN4RXDSR1 - MSCAN Data Segment Register 1 ***/
typedef union {
  byte Byte;
  struct {
    byte DB0     :1;           /* Data Bit 0 */
...
#define CAN4RXDSR1_DB _CAN4RXDSR1.MergedBits.DB

/*** CAN4RXDSR2 - MSCAN Data Segment Register 2 ***/
typedef union {
  byte Byte;
  struct {
    byte DB0     :1;           /* Data Bit 0 */
...
#define CAN4RXDSR2_DB _CAN4RXDSR2.MergedBits.DB

/*** CAN4RXDSR3 - MSCAN Data Segment Register 3 ***/
typedef union {
  byte Byte;
  struct {
    byte DB0     :1;           /* Data Bit 0 */
...
#define CAN4RXDSR3_DB _CAN4RXDSR3.MergedBits.DB

/*** CAN4RXDSR4 - MSCAN Data Segment Register 4 ***/
typedef union {
  byte Byte;
  struct {
    byte DB0     :1;           /* Data Bit 0 */
...
#define CAN4RXDSR4_DB _CAN4RXDSR4.MergedBits.DB

/*** CAN4RXDSR5 - MSCAN Data Segment Register 5 ***/
typedef union {
  byte Byte;
  struct {
    byte DB0     :1;           /* Data Bit 0 */
...
#define CAN4RXDSR5_DB _CAN4RXDSR5.MergedBits.DB

/*** CAN4RXDSR6 - MSCAN Data Segment Register 6 ***/
typedef union {
  byte Byte;
  struct {
    byte DB0     :1;           /* Data Bit 0 */
...
#define CAN4RXDSR6_DB _CAN4RXDSR6.MergedBits.DB

/*** CAN4RXDSR7 - MSCAN Data Segment Register 7 ***/
typedef union {
  byte Byte;
  struct {
    byte DB0     :1;           /* Data Bit 0 */
...
#define CAN4RXDSR7_DB _CAN4RXDSR7.MergedBits.DB

/*** CAN4RXDLR - MSCAN Data Length Register ***/
typedef union {
  byte Byte;
  struct {
    byte DLC0    :1;           /* Data Length Code Bit 0 */
...
#define CAN4RXDLR_DLC _CAN4RXDLR.MergedBits.DLC

/*** CAN4TXIDR0 - MSCAN Identifier Register 0 ***/
typedef union {
  byte Byte;
  struct {
    byte ID21    :1;           /* Extended format identifier Bit 21 */
...
#define CAN4TXIDR0_ID2_1 _CAN4TXIDR0.MergedBits.ID2_1

/*** CAN4TXIDR1 - MSCAN Identifier Register 1 ***/
typedef union {
  byte Byte;
  struct {
    byte ID15    :1;           /* Extended format identifier Bit 15 */
...
#define CAN4TXIDR1_ID1_5 _CAN4TXIDR1.MergedBits.ID1_5
#define CAN4TXIDR1_ID1_8 _CAN4TXIDR1.MergedBits.ID1_8

/*** CAN4TXIDR2 - MSCAN Identifier Register 2 ***/
typedef union {
  byte Byte;
  struct {
    byte ID7     :1;           /* Extended format identifier Bit 7 */
...
#define CAN4TXIDR2_ID_7 _CAN4TXIDR2.MergedBits.ID_7

/*** CAN4TXIDR3 - MSCAN Identifier Register 0 ***/
typedef union {
  byte Byte;
  struct {
    byte RTR     :1;           /* Remote Transmission Request */
...
#define CAN4TXIDR3_ID _CAN4TXIDR3.MergedBits.ID

/*** CAN4TXDSR0 - MSCAN Data Segment Register 0 ***/
typedef union {
  byte Byte;
  struct {
    byte DB0     :1;           /* Data Bit 0 */
...
#define CAN4TXDSR0_DB _CAN4TXDSR0.MergedBits.DB

/*** CAN4TXDSR1 - MSCAN Data Segment Register 1 ***/
typedef union {
  byte Byte;
  struct {
    byte DB0     :1;           /* Data Bit 0 */
...
#define CAN4TXDSR1_DB _CAN4TXDSR1.MergedBits.DB

/*** CAN4TXDSR2 - MSCAN Data Segment Register 2 ***/
typedef union {
  byte Byte;
  struct {
    byte DB0     :1;           /* Data Bit 0 */
...
#define CAN4TXDSR2_DB _CAN4TXDSR2.MergedBits.DB

/*** CAN4TXDSR3 - MSCAN Data Segment Register 3 ***/
typedef union {
  byte Byte;
  struct {
    byte DB0     :1;           /* Data Bit 0 */
...
#define CAN4TXDSR3_DB _CAN4TXDSR3.MergedBits.DB

/*** CAN4TXDSR4 - MSCAN Data Segment Register 4 ***/
typedef union {
  byte Byte;
  struct {
    byte DB0     :1;           /* Data Bit 0 */
...
#define CAN4TXDSR4_DB _CAN4TXDSR4.MergedBits.DB

/*** CAN4TXDSR5 - MSCAN Data Segment Register 5 ***/
typedef union {
  byte Byte;
  struct {
    byte DB0     :1;           /* Data Bit 0 */
...
#define CAN4TXDSR5_DB _CAN4TXDSR5.MergedBits.DB

/*** CAN4TXDSR6 - MSCAN Data Segment Register 6 ***/
typedef union {
  byte Byte;
  struct {
    byte DB0     :1;           /* Data Bit 0 */
...
#define CAN4TXDSR6_DB _CAN4TXDSR6.MergedBits.DB

/*** CAN4TXDSR7 - MSCAN Data Segment Register 7 ***/
typedef union {
  byte Byte;
  struct {
    byte DB0     :1;           /* Data Bit 0 */
...
#define CAN4TXDSR7_DB _CAN4TXDSR7.MergedBits.DB

/*** CAN4TXDLR - MSCAN Data Length Register ***/
typedef union {
  byte Byte;
  struct {
    byte DLC0    :1;           /* Data Length Code Bit 0 */
...
#define CAN4TXDLR_DLC _CAN4TXDLR.MergedBits.DLC

/*** CAN4TXTBPR - MSCAN Transmit Buffer Priority ***/
typedef union {
  byte Byte;
  struct {
    byte PRIO0   :1;           /* Transmit Buffer Priority Bit 0 */
...
#define CAN4TXTBPR_PRIO _CAN4TXTBPR.MergedBits.PRIO

/*** BDMSTS - BDM Status Register ***/
typedef union {
  byte Byte;
  struct {
    byte         :1; 
...
extern volatile BDMSTSSTR _BDMSTS @(REG_BASE + 0x0000FF01);
...
/*** BDMCCR - BDM CCR Holding Register ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile BDMCCRSTR _BDMCCR @(REG_BASE + 0x0000FF06);
...
#define BDMCCR_CCR _BDMCCR.MergedBits.CCR

/*** BDMINR - BDM Internal Register Position Register ***/
typedef union {
  byte Byte;
  struct {
    byte         :1; 
...
extern volatile BDMINRSTR _BDMINR @(REG_BASE + 0x0000FF07);
...
#define BDMINR_REG1_1 _BDMINR.MergedBits.REG1_1

/*** PORTAB - Port AB Register ***/
typedef union {
  word Word;
  struct {
    byte BIT0    :1;           /* Port B Bit 0, ADDR0, DATA0 */
    ...
    byte BIT6    :1;           /* Port B Bit6, ADDR6, DATA6 */
    byte BIT7    :1;           /* Port B Bit7, ADDR7, DATA7 */
    byte BIT8    :1;           /* Port A Bit0, ADDR8, DATA8, DATA0 */
    byte BIT9    :1;           /* Port A Bit1, ADDR9, DATA9 DATA1 */
    byte BIT10   :1;           /* Port A Bit2, ADDR10, DATA10, DATA2 */
    byte BIT11   :1;           /* Port A Bit3, ADDR11, DATA11, DATA3 */
    byte BIT12   :1;           /* Port A Bit4, ADDR12, DATA12, DATA4 */
    byte BIT13   :1;           /* Port A Bit5, ADDR13, DATA13, DATA5 */
    byte BIT14   :1;           /* Port A Bit6, ADDR14, DATA14, DATA6 */
    byte BIT15   :1;           /* Port A Bit7, ADDR15, DATA15, DATA7 */
  } Bits;
  struct {
    word BIT     :16;
  } MergedBits;
...
#define PORTAB_BIT _PORTAB.MergedBits.BIT

/*** DDRAB - Port AB Data Direction Register ***/
typedef union {
  word Word;
  struct {
    byte BIT0    :1;           /* Data Direction Port B Bit 0 */
    ...
    byte BIT6    :1;           /* Data Direction Port B Bit 6 */
    byte BIT7    :1;           /* Data Direction Port B Bit 7 */
    byte BIT8    :1;           /* Data Direction Port A Bit 8 */
    byte BIT9    :1;           /* Data Direction Port A Bit 9 */
    byte BIT10   :1;           /* Data Direction Port A Bit 10 */
    byte BIT11   :1;           /* Data Direction Port A Bit 11 */
    byte BIT12   :1;           /* Data Direction Port A Bit 12 */
    byte BIT13   :1;           /* Data Direction Port A Bit 13 */
    byte BIT14   :1;           /* Data Direction Port A Bit 14 */
    byte BIT15   :1;           /* Data Direction Port A Bit 15 */
  } Bits;
  struct {
    word BIT     :16;
  } MergedBits;
...
#define DDRAB_BIT _DDRAB.MergedBits.BIT
...
#define TC0_BIT0 _TC0.Bits.BIT0
#define TC0_BIT1 _TC0.Bits.BIT1
#define TC0_BIT2 _TC0.Bits.BIT2
#define TC0_BIT3 _TC0.Bits.BIT3
#define TC0_BIT4 _TC0.Bits.BIT4
#define TC0_BIT5 _TC0.Bits.BIT5
#define TC0_BIT6 _TC0.Bits.BIT6
#define TC0_BIT7 _TC0.Bits.BIT7
#define TC0_BIT8 _TC0.Bits.BIT8
#define TC0_BIT9 _TC0.Bits.BIT9
#define TC0_BIT10 _TC0.Bits.BIT10
#define TC0_BIT11 _TC0.Bits.BIT11
#define TC0_BIT12 _TC0.Bits.BIT12
#define TC0_BIT13 _TC0.Bits.BIT13
#define TC0_BIT14 _TC0.Bits.BIT14
#define TC0_BIT15 _TC0.Bits.BIT15
#define TC0_BIT _TC0.MergedBits.BIT
...
#define TC1_BIT0 _TC1.Bits.BIT0
#define TC1_BIT1 _TC1.Bits.BIT1
#define TC1_BIT2 _TC1.Bits.BIT2
#define TC1_BIT3 _TC1.Bits.BIT3
#define TC1_BIT4 _TC1.Bits.BIT4
#define TC1_BIT5 _TC1.Bits.BIT5
#define TC1_BIT6 _TC1.Bits.BIT6
#define TC1_BIT7 _TC1.Bits.BIT7
#define TC1_BIT8 _TC1.Bits.BIT8
#define TC1_BIT9 _TC1.Bits.BIT9
#define TC1_BIT10 _TC1.Bits.BIT10
#define TC1_BIT11 _TC1.Bits.BIT11
#define TC1_BIT12 _TC1.Bits.BIT12
#define TC1_BIT13 _TC1.Bits.BIT13
#define TC1_BIT14 _TC1.Bits.BIT14
#define TC1_BIT15 _TC1.Bits.BIT15
#define TC1_BIT _TC1.MergedBits.BIT
...
#define TC2_BIT0 _TC2.Bits.BIT0
#define TC2_BIT1 _TC2.Bits.BIT1
#define TC2_BIT2 _TC2.Bits.BIT2
#define TC2_BIT3 _TC2.Bits.BIT3
#define TC2_BIT4 _TC2.Bits.BIT4
#define TC2_BIT5 _TC2.Bits.BIT5
#define TC2_BIT6 _TC2.Bits.BIT6
#define TC2_BIT7 _TC2.Bits.BIT7
#define TC2_BIT8 _TC2.Bits.BIT8
#define TC2_BIT9 _TC2.Bits.BIT9
#define TC2_BIT10 _TC2.Bits.BIT10
#define TC2_BIT11 _TC2.Bits.BIT11
#define TC2_BIT12 _TC2.Bits.BIT12
#define TC2_BIT13 _TC2.Bits.BIT13
#define TC2_BIT14 _TC2.Bits.BIT14
#define TC2_BIT15 _TC2.Bits.BIT15
#define TC2_BIT _TC2.MergedBits.BIT
...
#define TC3_BIT0 _TC3.Bits.BIT0
#define TC3_BIT1 _TC3.Bits.BIT1
#define TC3_BIT2 _TC3.Bits.BIT2
#define TC3_BIT3 _TC3.Bits.BIT3
#define TC3_BIT4 _TC3.Bits.BIT4
#define TC3_BIT5 _TC3.Bits.BIT5
#define TC3_BIT6 _TC3.Bits.BIT6
#define TC3_BIT7 _TC3.Bits.BIT7
#define TC3_BIT8 _TC3.Bits.BIT8
#define TC3_BIT9 _TC3.Bits.BIT9
#define TC3_BIT10 _TC3.Bits.BIT10
#define TC3_BIT11 _TC3.Bits.BIT11
#define TC3_BIT12 _TC3.Bits.BIT12
#define TC3_BIT13 _TC3.Bits.BIT13
#define TC3_BIT14 _TC3.Bits.BIT14
#define TC3_BIT15 _TC3.Bits.BIT15
#define TC3_BIT _TC3.MergedBits.BIT
...
#define TC4_BIT0 _TC4.Bits.BIT0
#define TC4_BIT1 _TC4.Bits.BIT1
#define TC4_BIT2 _TC4.Bits.BIT2
#define TC4_BIT3 _TC4.Bits.BIT3
#define TC4_BIT4 _TC4.Bits.BIT4
#define TC4_BIT5 _TC4.Bits.BIT5
#define TC4_BIT6 _TC4.Bits.BIT6
#define TC4_BIT7 _TC4.Bits.BIT7
#define TC4_BIT8 _TC4.Bits.BIT8
#define TC4_BIT9 _TC4.Bits.BIT9
#define TC4_BIT10 _TC4.Bits.BIT10
#define TC4_BIT11 _TC4.Bits.BIT11
#define TC4_BIT12 _TC4.Bits.BIT12
#define TC4_BIT13 _TC4.Bits.BIT13
#define TC4_BIT14 _TC4.Bits.BIT14
#define TC4_BIT15 _TC4.Bits.BIT15
#define TC4_BIT _TC4.MergedBits.BIT
...
#define TC5_BIT0 _TC5.Bits.BIT0
#define TC5_BIT1 _TC5.Bits.BIT1
#define TC5_BIT2 _TC5.Bits.BIT2
#define TC5_BIT3 _TC5.Bits.BIT3
#define TC5_BIT4 _TC5.Bits.BIT4
#define TC5_BIT5 _TC5.Bits.BIT5
#define TC5_BIT6 _TC5.Bits.BIT6
#define TC5_BIT7 _TC5.Bits.BIT7
#define TC5_BIT8 _TC5.Bits.BIT8
#define TC5_BIT9 _TC5.Bits.BIT9
#define TC5_BIT10 _TC5.Bits.BIT10
#define TC5_BIT11 _TC5.Bits.BIT11
#define TC5_BIT12 _TC5.Bits.BIT12
#define TC5_BIT13 _TC5.Bits.BIT13
#define TC5_BIT14 _TC5.Bits.BIT14
#define TC5_BIT15 _TC5.Bits.BIT15
#define TC5_BIT _TC5.MergedBits.BIT
...
#define TC6_BIT0 _TC6.Bits.BIT0
#define TC6_BIT1 _TC6.Bits.BIT1
#define TC6_BIT2 _TC6.Bits.BIT2
#define TC6_BIT3 _TC6.Bits.BIT3
#define TC6_BIT4 _TC6.Bits.BIT4
#define TC6_BIT5 _TC6.Bits.BIT5
#define TC6_BIT6 _TC6.Bits.BIT6
#define TC6_BIT7 _TC6.Bits.BIT7
#define TC6_BIT8 _TC6.Bits.BIT8
#define TC6_BIT9 _TC6.Bits.BIT9
#define TC6_BIT10 _TC6.Bits.BIT10
#define TC6_BIT11 _TC6.Bits.BIT11
#define TC6_BIT12 _TC6.Bits.BIT12
#define TC6_BIT13 _TC6.Bits.BIT13
#define TC6_BIT14 _TC6.Bits.BIT14
#define TC6_BIT15 _TC6.Bits.BIT15
#define TC6_BIT _TC6.MergedBits.BIT
...
#define TC7_BIT0 _TC7.Bits.BIT0
#define TC7_BIT1 _TC7.Bits.BIT1
#define TC7_BIT2 _TC7.Bits.BIT2
#define TC7_BIT3 _TC7.Bits.BIT3
#define TC7_BIT4 _TC7.Bits.BIT4
#define TC7_BIT5 _TC7.Bits.BIT5
#define TC7_BIT6 _TC7.Bits.BIT6
#define TC7_BIT7 _TC7.Bits.BIT7
#define TC7_BIT8 _TC7.Bits.BIT8
#define TC7_BIT9 _TC7.Bits.BIT9
#define TC7_BIT10 _TC7.Bits.BIT10
#define TC7_BIT11 _TC7.Bits.BIT11
#define TC7_BIT12 _TC7.Bits.BIT12
#define TC7_BIT13 _TC7.Bits.BIT13
#define TC7_BIT14 _TC7.Bits.BIT14
#define TC7_BIT15 _TC7.Bits.BIT15
#define TC7_BIT _TC7.MergedBits.BIT

/*** PACN32 - Pulse Accumulators Count Register ***/
typedef union {
  word Word;
  struct {
    byte BIT0    :1;           /* Pulse Accumulator bit 0 */
    ...
    byte BIT6    :1;           /* Pulse Accumulator bit 6 */
    byte BIT7    :1;           /* Pulse Accumulator bit 7 */
    byte BIT8    :1;           /* Pulse Accumulator bit 8 */
    byte BIT9    :1;           /* Pulse Accumulator bit 9 */
    byte BIT10   :1;           /* Pulse Accumulator bit 10 */
    byte BIT11   :1;           /* Pulse Accumulator bit 11 */
    byte BIT12   :1;           /* Pulse Accumulator bit 12 */
    byte BIT13   :1;           /* Pulse Accumulator bit 13 */
    byte BIT14   :1;           /* Pulse Accumulator bit 14 */
    byte BIT15   :1;           /* Pulse Accumulator bit 15 */
  } Bits;
  struct {
    word BIT     :16;
  } MergedBits;
...
#define PACN32_BIT0 _PACN32.Bits.BIT0
#define PACN32_BIT1 _PACN32.Bits.BIT1
#define PACN32_BIT2 _PACN32.Bits.BIT2
#define PACN32_BIT3 _PACN32.Bits.BIT3
#define PACN32_BIT4 _PACN32.Bits.BIT4
#define PACN32_BIT5 _PACN32.Bits.BIT5
#define PACN32_BIT6 _PACN32.Bits.BIT6
#define PACN32_BIT7 _PACN32.Bits.BIT7
#define PACN32_BIT8 _PACN32.Bits.BIT8
#define PACN32_BIT9 _PACN32.Bits.BIT9
#define PACN32_BIT10 _PACN32.Bits.BIT10
#define PACN32_BIT11 _PACN32.Bits.BIT11
#define PACN32_BIT12 _PACN32.Bits.BIT12
#define PACN32_BIT13 _PACN32.Bits.BIT13
#define PACN32_BIT14 _PACN32.Bits.BIT14
#define PACN32_BIT15 _PACN32.Bits.BIT15
#define PACN32_BIT _PACN32.MergedBits.BIT

/*** PACN10 - Pulse Accumulators Count Register ***/
typedef union {
  word Word;
  struct {
    byte BIT0    :1;           /* Pulse Accumulator bit 0 */
...
#define PACN10_BIT0 _PACN10.Bits.BIT0
#define PACN10_BIT1 _PACN10.Bits.BIT1
#define PACN10_BIT2 _PACN10.Bits.BIT2
#define PACN10_BIT3 _PACN10.Bits.BIT3
#define PACN10_BIT4 _PACN10.Bits.BIT4
#define PACN10_BIT5 _PACN10.Bits.BIT5
#define PACN10_BIT6 _PACN10.Bits.BIT6
#define PACN10_BIT7 _PACN10.Bits.BIT7
#define PACN10_BIT8 _PACN10.Bits.BIT8
#define PACN10_BIT9 _PACN10.Bits.BIT9
#define PACN10_BIT10 _PACN10.Bits.BIT10
#define PACN10_BIT11 _PACN10.Bits.BIT11
#define PACN10_BIT12 _PACN10.Bits.BIT12
#define PACN10_BIT13 _PACN10.Bits.BIT13
#define PACN10_BIT14 _PACN10.Bits.BIT14
#define PACN10_BIT15 _PACN10.Bits.BIT15
#define PACN10_BIT _PACN10.MergedBits.BIT

/*** PA32H - 8-Bit Pulse Accumulators Holding ***/
typedef union {
  word Word;
  struct {
    byte BIT0    :1;           /* Pulse Accumulator Bit 0 */
...
#define PA32H_BIT _PA32H.MergedBits.BIT

/*** PA10H - 8-Bit Pulse Accumulators Holding ***/
typedef union {
  word Word;
  struct {
    byte BIT0    :1;           /* Pulse Accumulator Bit 0 */
...
#define PA10H_BIT _PA10H.MergedBits.BIT
...
#define MCCNT_BIT0 _MCCNT.Bits.BIT0
#define MCCNT_BIT1 _MCCNT.Bits.BIT1
#define MCCNT_BIT2 _MCCNT.Bits.BIT2
#define MCCNT_BIT3 _MCCNT.Bits.BIT3
#define MCCNT_BIT4 _MCCNT.Bits.BIT4
#define MCCNT_BIT5 _MCCNT.Bits.BIT5
#define MCCNT_BIT6 _MCCNT.Bits.BIT6
#define MCCNT_BIT7 _MCCNT.Bits.BIT7
#define MCCNT_BIT8 _MCCNT.Bits.BIT8
#define MCCNT_BIT9 _MCCNT.Bits.BIT9
#define MCCNT_BIT10 _MCCNT.Bits.BIT10
#define MCCNT_BIT11 _MCCNT.Bits.BIT11
#define MCCNT_BIT12 _MCCNT.Bits.BIT12
#define MCCNT_BIT13 _MCCNT.Bits.BIT13
#define MCCNT_BIT14 _MCCNT.Bits.BIT14
#define MCCNT_BIT15 _MCCNT.Bits.BIT15
#define MCCNT_BIT _MCCNT.MergedBits.BIT

/*** TC0H - Timer Input Capture Holding Registers 0 ***/
typedef union {
  word Word;
  struct {
    byte BIT0    :1;           /* Timer Input Capture Holding Bit 0 */
...
#define TC0H_BIT _TC0H.MergedBits.BIT

/*** TC1H - Timer Input Capture Holding Registers 1 ***/
typedef union {
  word Word;
  struct {
    byte BIT0    :1;           /* Timer Input Capture Holding Bit 0 */
...
#define TC1H_BIT _TC1H.MergedBits.BIT

/*** TC2H - Timer Input Capture Holding Registers 2 ***/
typedef union {
  word Word;
  struct {
    byte BIT0    :1;           /* Timer Input Capture Holding Bit 0 */
...
#define TC2H_BIT _TC2H.MergedBits.BIT

/*** TC3H - Timer Input Capture Holding Registers 3 ***/
typedef union {
  word Word;
  struct {
    byte BIT0    :1;           /* Timer Input Capture Holding Bit 0 */
...
#define TC3H_BIT _TC3H.MergedBits.BIT

/*** ATD0CTL23 - ATD Control Register 23 ***/
typedef union {
  word Word;
  struct {
    byte FRZ0    :1;           /* Background Debug Freeze Enable */
...
#define ATD0CTL23_FRZ _ATD0CTL23.MergedBits.FRZ

/*** ATD0CTL45 - ATD Control Register 45 ***/
typedef union {
  word Word;
  struct {
    byte CA      :1;           /* Analog Input Channel Select Code */
...
#define ATD0CTL45_PRS _ATD0CTL45.MergedBits.PRS
#define ATD0CTL45_SMP _ATD0CTL45.MergedBits.SMP

/*** ATD0DR0 - A/D Conversion Result Register 0 ***/
typedef union {
  word Word;
  struct {
    byte         :1; 
...
#define ATD0DR0_BIT_6 _ATD0DR0.MergedBits.BIT_6

/*** ATD0DR1 - A/D Conversion Result Register 1 ***/
typedef union {
  word Word;
  struct {
    byte         :1; 
...
#define ATD0DR1_BIT_6 _ATD0DR1.MergedBits.BIT_6

/*** ATD0DR2 - A/D Conversion Result Register 2 ***/
typedef union {
  word Word;
  struct {
    byte         :1; 
...
#define ATD0DR2_BIT_6 _ATD0DR2.MergedBits.BIT_6

/*** ATD0DR3 - A/D Conversion Result Register 3 ***/
typedef union {
  word Word;
  struct {
    byte         :1; 
...
#define ATD0DR3_BIT_6 _ATD0DR3.MergedBits.BIT_6

/*** ATD0DR4 - A/D Conversion Result Register 4 ***/
typedef union {
  word Word;
  struct {
    byte         :1; 
...
#define ATD0DR4_BIT_6 _ATD0DR4.MergedBits.BIT_6

/*** ATD0DR5 - A/D Conversion Result Register 5 ***/
typedef union {
  word Word;
  struct {
    byte         :1; 
...
#define ATD0DR5_BIT_6 _ATD0DR5.MergedBits.BIT_6

/*** ATD0DR6 - A/D Conversion Result Register 6 ***/
typedef union {
  word Word;
  struct {
    byte         :1; 
...
#define ATD0DR6_BIT_6 _ATD0DR6.MergedBits.BIT_6

/*** ATD0DR7 - A/D Conversion Result Register 7 ***/
typedef union {
  word Word;
  struct {
    byte         :1; 
...
#define ATD0DR7_BIT_6 _ATD0DR7.MergedBits.BIT_6

/*** PWMCNT01 - PWM Channel Counter ***/
typedef union {
  word Word;
  struct {
    byte BIT0    :1;           /* PWM Channel Counter Bit 0 */
    ...
    byte BIT6    :1;           /* PWM Channel Counter Bit 6 */
    byte BIT7    :1;           /* PWM Channel Counter Bit 7 */
    byte BIT8    :1;           /* PWM Channel Counter Bit 8 */
    byte BIT9    :1;           /* PWM Channel Counter Bit 9 */
    byte BIT10   :1;           /* PWM Channel Counter Bit 10 */
    byte BIT11   :1;           /* PWM Channel Counter Bit 11 */
    byte BIT12   :1;           /* PWM Channel Counter Bit 12 */
    byte BIT13   :1;           /* PWM Channel Counter Bit 13 */
    byte BIT14   :1;           /* PWM Channel Counter Bit 14 */
    byte BIT15   :1;           /* PWM Channel Counter Bit 15 */
  } Bits;
  struct {
    word BIT     :16;
  } MergedBits;
...
#define PWMCNT01_BIT0 _PWMCNT01.Bits.BIT0
#define PWMCNT01_BIT1 _PWMCNT01.Bits.BIT1
#define PWMCNT01_BIT2 _PWMCNT01.Bits.BIT2
#define PWMCNT01_BIT3 _PWMCNT01.Bits.BIT3
#define PWMCNT01_BIT4 _PWMCNT01.Bits.BIT4
#define PWMCNT01_BIT5 _PWMCNT01.Bits.BIT5
#define PWMCNT01_BIT6 _PWMCNT01.Bits.BIT6
#define PWMCNT01_BIT7 _PWMCNT01.Bits.BIT7
#define PWMCNT01_BIT8 _PWMCNT01.Bits.BIT8
#define PWMCNT01_BIT9 _PWMCNT01.Bits.BIT9
#define PWMCNT01_BIT10 _PWMCNT01.Bits.BIT10
#define PWMCNT01_BIT11 _PWMCNT01.Bits.BIT11
#define PWMCNT01_BIT12 _PWMCNT01.Bits.BIT12
#define PWMCNT01_BIT13 _PWMCNT01.Bits.BIT13
#define PWMCNT01_BIT14 _PWMCNT01.Bits.BIT14
#define PWMCNT01_BIT15 _PWMCNT01.Bits.BIT15
#define PWMCNT01_BIT _PWMCNT01.MergedBits.BIT

/*** PWMCNT23 - PWM Channel Counter ***/
typedef union {
  word Word;
  struct {
    byte BIT0    :1;           /* PWM Channel Counter Bit 0 */
...
#define PWMCNT23_BIT0 _PWMCNT23.Bits.BIT0
#define PWMCNT23_BIT1 _PWMCNT23.Bits.BIT1
#define PWMCNT23_BIT2 _PWMCNT23.Bits.BIT2
#define PWMCNT23_BIT3 _PWMCNT23.Bits.BIT3
#define PWMCNT23_BIT4 _PWMCNT23.Bits.BIT4
#define PWMCNT23_BIT5 _PWMCNT23.Bits.BIT5
#define PWMCNT23_BIT6 _PWMCNT23.Bits.BIT6
#define PWMCNT23_BIT7 _PWMCNT23.Bits.BIT7
#define PWMCNT23_BIT8 _PWMCNT23.Bits.BIT8
#define PWMCNT23_BIT9 _PWMCNT23.Bits.BIT9
#define PWMCNT23_BIT10 _PWMCNT23.Bits.BIT10
#define PWMCNT23_BIT11 _PWMCNT23.Bits.BIT11
#define PWMCNT23_BIT12 _PWMCNT23.Bits.BIT12
#define PWMCNT23_BIT13 _PWMCNT23.Bits.BIT13
#define PWMCNT23_BIT14 _PWMCNT23.Bits.BIT14
#define PWMCNT23_BIT15 _PWMCNT23.Bits.BIT15
#define PWMCNT23_BIT _PWMCNT23.MergedBits.BIT

/*** PWMCNT45 - PWM Channel Counter ***/
typedef union {
  word Word;
  struct {
    byte BIT0    :1;           /* PWM Channel Counter Bit 0 */
...
#define PWMCNT45_BIT _PWMCNT45.MergedBits.BIT

/*** PWMCNT67 - PWM Channel Counter ***/
typedef union {
  word Word;
  struct {
    byte BIT0    :1;           /* PWM Channel Counter Bit 0 */
...
#define PWMCNT67_BIT0 _PWMCNT67.Bits.BIT0
#define PWMCNT67_BIT1 _PWMCNT67.Bits.BIT1
#define PWMCNT67_BIT2 _PWMCNT67.Bits.BIT2
#define PWMCNT67_BIT3 _PWMCNT67.Bits.BIT3
#define PWMCNT67_BIT4 _PWMCNT67.Bits.BIT4
#define PWMCNT67_BIT5 _PWMCNT67.Bits.BIT5
#define PWMCNT67_BIT6 _PWMCNT67.Bits.BIT6
#define PWMCNT67_BIT7 _PWMCNT67.Bits.BIT7
#define PWMCNT67_BIT8 _PWMCNT67.Bits.BIT8
#define PWMCNT67_BIT9 _PWMCNT67.Bits.BIT9
#define PWMCNT67_BIT10 _PWMCNT67.Bits.BIT10
#define PWMCNT67_BIT11 _PWMCNT67.Bits.BIT11
#define PWMCNT67_BIT12 _PWMCNT67.Bits.BIT12
#define PWMCNT67_BIT13 _PWMCNT67.Bits.BIT13
#define PWMCNT67_BIT14 _PWMCNT67.Bits.BIT14
#define PWMCNT67_BIT15 _PWMCNT67.Bits.BIT15
#define PWMCNT67_BIT _PWMCNT67.MergedBits.BIT

/*** PWMPER01 - PWM Channel Period ***/
typedef union {
  word Word;
  struct {
    byte BIT0    :1;           /* PWM Channel Period Bit 0 */
    ...
    byte BIT6    :1;           /* PWM Channel Period Bit 6 */
    byte BIT7    :1;           /* PWM Channel Period Bit 7 */
    byte BIT8    :1;           /* PWM Channel Period Bit 8 */
    byte BIT9    :1;           /* PWM Channel Period Bit 9 */
    byte BIT10   :1;           /* PWM Channel Period Bit 10 */
    byte BIT11   :1;           /* PWM Channel Period Bit 11 */
    byte BIT12   :1;           /* PWM Channel Period Bit 12 */
    byte BIT13   :1;           /* PWM Channel Period Bit 13 */
    byte BIT14   :1;           /* PWM Channel Period Bit 14 */
    byte BIT15   :1;           /* PWM Channel Period Bit 15 */
  } Bits;
  struct {
    word BIT     :16;
  } MergedBits;
...
#define PWMPER01_BIT0 _PWMPER01.Bits.BIT0
#define PWMPER01_BIT1 _PWMPER01.Bits.BIT1
#define PWMPER01_BIT2 _PWMPER01.Bits.BIT2
#define PWMPER01_BIT3 _PWMPER01.Bits.BIT3
#define PWMPER01_BIT4 _PWMPER01.Bits.BIT4
#define PWMPER01_BIT5 _PWMPER01.Bits.BIT5
#define PWMPER01_BIT6 _PWMPER01.Bits.BIT6
#define PWMPER01_BIT7 _PWMPER01.Bits.BIT7
#define PWMPER01_BIT8 _PWMPER01.Bits.BIT8
#define PWMPER01_BIT9 _PWMPER01.Bits.BIT9
#define PWMPER01_BIT10 _PWMPER01.Bits.BIT10
#define PWMPER01_BIT11 _PWMPER01.Bits.BIT11
#define PWMPER01_BIT12 _PWMPER01.Bits.BIT12
#define PWMPER01_BIT13 _PWMPER01.Bits.BIT13
#define PWMPER01_BIT14 _PWMPER01.Bits.BIT14
#define PWMPER01_BIT15 _PWMPER01.Bits.BIT15
#define PWMPER01_BIT _PWMPER01.MergedBits.BIT

/*** PWMPER23 - PWM Channel Period ***/
typedef union {
  word Word;
  struct {
    byte BIT0    :1;           /* PWM Channel Period Bit 0 */
...
#define PWMPER23_BIT0 _PWMPER23.Bits.BIT0
#define PWMPER23_BIT1 _PWMPER23.Bits.BIT1
#define PWMPER23_BIT2 _PWMPER23.Bits.BIT2
#define PWMPER23_BIT3 _PWMPER23.Bits.BIT3
#define PWMPER23_BIT4 _PWMPER23.Bits.BIT4
#define PWMPER23_BIT5 _PWMPER23.Bits.BIT5
#define PWMPER23_BIT6 _PWMPER23.Bits.BIT6
#define PWMPER23_BIT7 _PWMPER23.Bits.BIT7
#define PWMPER23_BIT8 _PWMPER23.Bits.BIT8
#define PWMPER23_BIT9 _PWMPER23.Bits.BIT9
#define PWMPER23_BIT10 _PWMPER23.Bits.BIT10
#define PWMPER23_BIT11 _PWMPER23.Bits.BIT11
#define PWMPER23_BIT12 _PWMPER23.Bits.BIT12
#define PWMPER23_BIT13 _PWMPER23.Bits.BIT13
#define PWMPER23_BIT14 _PWMPER23.Bits.BIT14
#define PWMPER23_BIT15 _PWMPER23.Bits.BIT15
#define PWMPER23_BIT _PWMPER23.MergedBits.BIT

/*** PWMPER45 - PWM Channel Period ***/
typedef union {
  word Word;
  struct {
    byte BIT0    :1;           /* PWM Channel Period Bit 0 */
...
#define PWMPER45_BIT _PWMPER45.MergedBits.BIT

/*** PWMPER67 - PWM Channel Period ***/
typedef union {
  word Word;
  struct {
    byte BIT0    :1;           /* PWM Channel Period Bit 0 */
...
#define PWMPER67_BIT0 _PWMPER67.Bits.BIT0
#define PWMPER67_BIT1 _PWMPER67.Bits.BIT1
#define PWMPER67_BIT2 _PWMPER67.Bits.BIT2
#define PWMPER67_BIT3 _PWMPER67.Bits.BIT3
#define PWMPER67_BIT4 _PWMPER67.Bits.BIT4
#define PWMPER67_BIT5 _PWMPER67.Bits.BIT5
#define PWMPER67_BIT6 _PWMPER67.Bits.BIT6
#define PWMPER67_BIT7 _PWMPER67.Bits.BIT7
#define PWMPER67_BIT8 _PWMPER67.Bits.BIT8
#define PWMPER67_BIT9 _PWMPER67.Bits.BIT9
#define PWMPER67_BIT10 _PWMPER67.Bits.BIT10
#define PWMPER67_BIT11 _PWMPER67.Bits.BIT11
#define PWMPER67_BIT12 _PWMPER67.Bits.BIT12
#define PWMPER67_BIT13 _PWMPER67.Bits.BIT13
#define PWMPER67_BIT14 _PWMPER67.Bits.BIT14
#define PWMPER67_BIT15 _PWMPER67.Bits.BIT15
#define PWMPER67_BIT _PWMPER67.MergedBits.BIT

/*** PWMDTY01 - PWM Channel Duty ***/
typedef union {
  word Word;
  struct {
    byte BIT0    :1;           /* PWM Channel Duty Bit 0 */
    ...
    byte BIT6    :1;           /* PWM Channel Duty Bit 6 */
    byte BIT7    :1;           /* PWM Channel Duty Bit 7 */
    byte BIT8    :1;           /* PWM Channel Duty Bit 8 */
    byte BIT9    :1;           /* PWM Channel Duty Bit 9 */
    byte BIT10   :1;           /* PWM Channel Duty Bit 10 */
    byte BIT11   :1;           /* PWM Channel Duty Bit 11 */
    byte BIT12   :1;           /* PWM Channel Duty Bit 12 */
    byte BIT13   :1;           /* PWM Channel Duty Bit 13 */
    byte BIT14   :1;           /* PWM Channel Duty Bit 14 */
    byte BIT15   :1;           /* PWM Channel Duty Bit 15 */
  } Bits;
  struct {
    word BIT     :16;
  } MergedBits;
...
#define PWMDTY01_BIT0 _PWMDTY01.Bits.BIT0
#define PWMDTY01_BIT1 _PWMDTY01.Bits.BIT1
#define PWMDTY01_BIT2 _PWMDTY01.Bits.BIT2
#define PWMDTY01_BIT3 _PWMDTY01.Bits.BIT3
#define PWMDTY01_BIT4 _PWMDTY01.Bits.BIT4
#define PWMDTY01_BIT5 _PWMDTY01.Bits.BIT5
#define PWMDTY01_BIT6 _PWMDTY01.Bits.BIT6
#define PWMDTY01_BIT7 _PWMDTY01.Bits.BIT7
#define PWMDTY01_BIT8 _PWMDTY01.Bits.BIT8
#define PWMDTY01_BIT9 _PWMDTY01.Bits.BIT9
#define PWMDTY01_BIT10 _PWMDTY01.Bits.BIT10
#define PWMDTY01_BIT11 _PWMDTY01.Bits.BIT11
#define PWMDTY01_BIT12 _PWMDTY01.Bits.BIT12
#define PWMDTY01_BIT13 _PWMDTY01.Bits.BIT13
#define PWMDTY01_BIT14 _PWMDTY01.Bits.BIT14
#define PWMDTY01_BIT15 _PWMDTY01.Bits.BIT15
#define PWMDTY01_BIT _PWMDTY01.MergedBits.BIT

/*** PWMDTY23 - PWM Channel Duty ***/
typedef union {
  word Word;
  struct {
    byte BIT0    :1;           /* PWM Channel Duty Bit 0 */
...
#define PWMDTY23_BIT0 _PWMDTY23.Bits.BIT0
#define PWMDTY23_BIT1 _PWMDTY23.Bits.BIT1
#define PWMDTY23_BIT2 _PWMDTY23.Bits.BIT2
#define PWMDTY23_BIT3 _PWMDTY23.Bits.BIT3
#define PWMDTY23_BIT4 _PWMDTY23.Bits.BIT4
#define PWMDTY23_BIT5 _PWMDTY23.Bits.BIT5
#define PWMDTY23_BIT6 _PWMDTY23.Bits.BIT6
#define PWMDTY23_BIT7 _PWMDTY23.Bits.BIT7
#define PWMDTY23_BIT8 _PWMDTY23.Bits.BIT8
#define PWMDTY23_BIT9 _PWMDTY23.Bits.BIT9
#define PWMDTY23_BIT10 _PWMDTY23.Bits.BIT10
#define PWMDTY23_BIT11 _PWMDTY23.Bits.BIT11
#define PWMDTY23_BIT12 _PWMDTY23.Bits.BIT12
#define PWMDTY23_BIT13 _PWMDTY23.Bits.BIT13
#define PWMDTY23_BIT14 _PWMDTY23.Bits.BIT14
#define PWMDTY23_BIT15 _PWMDTY23.Bits.BIT15
#define PWMDTY23_BIT _PWMDTY23.MergedBits.BIT

/*** PWMDTY45 - PWM Channel Duty ***/
typedef union {
  word Word;
  struct {
    byte BIT0    :1;           /* PWM Channel Duty Bit 0 */
...
#define PWMDTY45_BIT _PWMDTY45.MergedBits.BIT

/*** PWMDTY67 - PWM Channel Duty ***/
typedef union {
  word Word;
  struct {
    byte BIT0    :1;           /* PWM Channel Duty Bit 0 */
...
#define PWMDTY67_BIT0 _PWMDTY67.Bits.BIT0
#define PWMDTY67_BIT1 _PWMDTY67.Bits.BIT1
#define PWMDTY67_BIT2 _PWMDTY67.Bits.BIT2
#define PWMDTY67_BIT3 _PWMDTY67.Bits.BIT3
#define PWMDTY67_BIT4 _PWMDTY67.Bits.BIT4
#define PWMDTY67_BIT5 _PWMDTY67.Bits.BIT5
#define PWMDTY67_BIT6 _PWMDTY67.Bits.BIT6
#define PWMDTY67_BIT7 _PWMDTY67.Bits.BIT7
#define PWMDTY67_BIT8 _PWMDTY67.Bits.BIT8
#define PWMDTY67_BIT9 _PWMDTY67.Bits.BIT9
#define PWMDTY67_BIT10 _PWMDTY67.Bits.BIT10
#define PWMDTY67_BIT11 _PWMDTY67.Bits.BIT11
#define PWMDTY67_BIT12 _PWMDTY67.Bits.BIT12
#define PWMDTY67_BIT13 _PWMDTY67.Bits.BIT13
#define PWMDTY67_BIT14 _PWMDTY67.Bits.BIT14
#define PWMDTY67_BIT15 _PWMDTY67.Bits.BIT15
#define PWMDTY67_BIT _PWMDTY67.MergedBits.BIT

/*** SCI0BD - SCI Baud Rate Register ***/
typedef union {
  word Word;
  struct {
    byte SBR0    :1;           /* SCI baud rate Bit 0 */
...
#define SCI0BD_SBR _SCI0BD.MergedBits.SBR

/*** SCI1BD - SCI Baud Rate Register ***/
typedef union {
  word Word;
  struct {
    byte SBR0    :1;           /* SCI baud rate Bit 0 */
...
#define SCI1BD_SBR _SCI1BD.MergedBits.SBR

/*** ATD1CTL23 - ATD Control Register 23 ***/
typedef union {
  word Word;
  struct {
    byte FRZ0    :1;           /* Background Debug Freeze Enable */
...
#define ATD1CTL23_FRZ _ATD1CTL23.MergedBits.FRZ

/*** ATD1CTL45 - ATD Control Register 45 ***/
typedef union {
  word Word;
  struct {
    byte CA      :1;           /* Analog Input Channel Select Code */
...
#define ATD1CTL45_PRS _ATD1CTL45.MergedBits.PRS
#define ATD1CTL45_SMP _ATD1CTL45.MergedBits.SMP

/*** ATD1DR0 - A/D Conversion Result Register 0 ***/
typedef union {
  word Word;
  struct {
    byte         :1; 
...
#define ATD1DR0_BIT_6 _ATD1DR0.MergedBits.BIT_6

/*** ATD1DR1 - A/D Conversion Result Register 1 ***/
typedef union {
  word Word;
  struct {
    byte         :1; 
...
#define ATD1DR1_BIT_6 _ATD1DR1.MergedBits.BIT_6

/*** ATD1DR2 - A/D Conversion Result Register 2 ***/
typedef union {
  word Word;
  struct {
    byte         :1; 
...
#define ATD1DR2_BIT_6 _ATD1DR2.MergedBits.BIT_6

/*** ATD1DR3 - A/D Conversion Result Register 3 ***/
typedef union {
  word Word;
  struct {
    byte         :1; 
...
#define ATD1DR3_BIT_6 _ATD1DR3.MergedBits.BIT_6

/*** ATD1DR4 - A/D Conversion Result Register 4 ***/
typedef union {
  word Word;
  struct {
    byte         :1; 
...
#define ATD1DR4_BIT_6 _ATD1DR4.MergedBits.BIT_6

/*** ATD1DR5 - A/D Conversion Result Register 5 ***/
typedef union {
  word Word;
  struct {
    byte         :1; 
...
#define ATD1DR5_BIT_6 _ATD1DR5.MergedBits.BIT_6

/*** ATD1DR6 - A/D Conversion Result Register 6 ***/
typedef union {
  word Word;
  struct {
    byte         :1; 
...
#define ATD1DR6_BIT_6 _ATD1DR6.MergedBits.BIT_6

/*** ATD1DR7 - A/D Conversion Result Register 7 ***/
typedef union {
  word Word;
  struct {
    byte         :1; 
...
#define ATD1DR7_BIT_6 _ATD1DR7.MergedBits.BIT_6
