...
$Log: candrv.h $
    ...
    ***********************************************
    ...
    User: TrevorM     Date: 08/18/10  Time: 04:26PM
    Changed CANDRV_TX_BUFFERS to 16 for Luminary micro test

    ***********************************************
    Revision: XanBus_TrevorM/1
    User: TrevorM     Date: 08/13/10  Time: 07:35PM
    Added Luminary Micro Xanbus port

    ***********************************************
    Revision: XanBus_HollyZ/4
    User: HollyZ     Date: 02/11/09  Time: 07:36PM
    Added function prototype to get the CAN Tx transmitter status
...
#elif ( CTRL_CONFIG_MANUFACTURER == MANUFACTURER_LUMINARY_MICRO )
#define CANDRV_TX_BUFFERS       ( 16 )
#endif
...
// Check if the CAN transmitter is sending messages out successfully
tucBOOL CANDRV_fnIsTransmitting( uchar8 Channel );

// Reset the statistic counters for CAN hardware
