...
#define TI_281x_MAX_PORTS           ( 4 )   // 0: CAN0, 1:CAN0_VIP, 2: CAN1, 3:CAN1_VIP

#define CANBUF_TI_281x_RX_PORT_BUFS ( 40 )
#define CANBUF_TI_281x_TX_PORT_BUFS	( 30 )

#define NUM_TX_MSG_HANDLES          ( CANBUF_TI_281x_TX_PORT_BUFS * 2 ) // REG BUF + VIP BUF)
/*==============================================================================
                            Type Definitions
==============================================================================*/
