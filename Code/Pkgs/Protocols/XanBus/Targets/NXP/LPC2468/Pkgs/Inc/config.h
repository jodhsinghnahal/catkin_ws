...
$Log: config.h $
    ...
    ***********************************************
    ...
    User: TrevorM     Date: 08/18/10  Time: 04:21PM
    Changed CTRL_CONFIG_MANUFACTURER to Luminary to set the correct number
    of transmit buffers
...
#define CTRL_CONFIG_MANUFACTURER ( MANUFACTURER_LUMINARY_MICRO )
