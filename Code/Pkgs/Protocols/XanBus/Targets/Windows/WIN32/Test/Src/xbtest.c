...
the express written permission of Xantrex Technology Inc.
...
#include <windows.h>    // For threads and critical sections
...
CRITICAL_SECTION XbShare;           // Mutex
...
// -- Internal functions --
DWORD WINAPI fnTickThread( LPVOID pParam );
...
{
    InitializeCriticalSection( &XbShare );
}
